									...
									<div class="card-body pb-0 dz-scroll height630 loadmore-content" id="latestSalesContent">
										<div class="pb-3 mb-3 border-bottom">
											...
											<div class="d-flex align-items-end">
												<img src="{{url('public/admin')}}/images/profile/20.jpg" alt="" width="42" class="rounded-circle mr-2">
												<div class="mr-auto">
										...
										<div class="pb-3 mb-3 border-bottom">
											...
											<div class="d-flex align-items-end">
												<img src="{{url('public/admin')}}/images/profile/21.jpg" alt="" width="42" class="rounded-circle mr-2">
												<div class="mr-auto">
										...
										<div class="pb-3 mb-3 border-bottom">
											...
											<div class="d-flex align-items-end">
												<img src="{{url('public/admin')}}/images/profile/22.jpg" alt="" width="42" class="rounded-circle mr-2">
												<div class="mr-auto">
										...
										<div class="pb-3 mb-3 border-bottom">
											...
											<div class="d-flex align-items-end">
												<img src="{{url('public/admin')}}/images/profile/23.jpg" alt="" width="42" class="rounded-circle mr-2">
												<div class="mr-auto">
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="event-bx owl-carousel">
											<div class="items">
												<div class="image-bx">
													<img src="{{url('public/admin')}}/images/events/1.png" alt="">
													<div class="info">
											...
											<div class="items">
												<div class="image-bx">
													<img src="{{url('public/admin')}}/images/events/3.png" alt="">
													<div class="info">
											...
											<div class="items">
												<div class="image-bx">
													<img src="{{url('public/admin')}}/images/events/2.png" alt="">
													<div class="info">
