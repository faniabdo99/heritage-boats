    ...
    <main class="main">
        ...
        <section class="promo-primary">
            ...
            <picture class="wow fadeIn">
                <source srcset="{{getCounterValues()->AcknowledgmentsPath}}" media="(min-width: 992px)" /><img class="img-bg wow fadeIn" src="{{getCounterValues()->AcknowledgmentsPath}}" alt="img" />
            </picture>
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="logos logos--primary">
                            <div class="container">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-5 col-12">
                                        <!-- item start-->
                                        <div class="logo-item logo-item--grayscaled alpha-logo"><img src="{{url('public/img')}}/brand-3.png" alt="logo"/></div>
                                        <!-- item end-->
                                    </div>
