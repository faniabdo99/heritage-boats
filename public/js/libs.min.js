! function (t, e) {
    ...
    p.fn.emulateTransitionEnd = i, p.event.special[g.TRANSITION_END] = {
        bindType: e,
        delegateType: e,
        handle: function (t) {
        ...
        m = function () {
            ...
            return t.close = function (t) {
                ...
                var e = g.getSelectorFromElement(t),
                    i = !1;
                return e && (i = document.querySelector(e)), i = i || p(t).closest("." + d)[0]
    ...
    p(document).on(h.CLICK_DATA_API, '[data-dismiss="alert"]', m._handleDismiss(new m)), p.fn[o] = m._jQueryInterface, p.fn[o].Constructor = m, p.fn[o].noConflict = function () {
    ...
    var v = "button",
        ...
        P = function () {
            ...
            return t.toggle = function () {
                ...
                if (i) {
                    ...
                    if (n) {
                        if ("radio" === n.type)
                            ...
                            n.checked = !this._element.classList.contains(w), p(n).trigger("change")
                        }
                        n.focus(), e = !1
                    }
                }
                ...
                return this.each(function () {
                    var t = p(this).data(b);
                    t || (t = new i(this), p(this).data(b, t)), "toggle" === e && t[e]()
                })
            }, r(i, null, [{
                key: "VERSION",
                get: function () {
    ...
    p(document).on(A.CLICK_DATA_API, T, function (t) {
        t.preventDefault();
        var e = t.target;
        p(e).hasClass(S) || (e = p(e).closest(M)), P._jQueryInterface.call(p(e), "toggle")
    ...
    var D = "carousel",
        ...
        at = function () {
            ...
            return t.next = function () {
                ...
                p(this._element).off(O), p.removeData(this._element, $), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
                ...
                if (this._touchSupported) {
                    ...
                    p(this._element.querySelectorAll(et)).on(B.DRAG_START, function (t) {
                        return t.preventDefault()
                    }), this._pointerEvent ? (p(this._element).on(B.POINTERDOWN, function (t) {
                        return e(t)
                    }), p(this._element).on(B.POINTERUP, function (t) {
                        return n(t)
                    }), this._element.classList.add(G)) : (p(this._element).on(B.TOUCHSTART, function (t) {
                        return e(t)
                ...
                if (o = t === N ? (i = X, n = Q, j) : (i = Y, n = K, W), l && p(l).hasClass(V)) this._isSliding = !1;
                    ...
                    if (p(this._element).hasClass(U)) {
                        ...
                        p(r).one(g.TRANSITION_END, function () {
                            p(l).removeClass(i + " " + n).addClass(V), p(r).removeClass(V + " " + n + " " + i), s._isSliding = !1, setTimeout(function () {
                                return p(s._element).trigger(d)
                            }, 0)
                        }).emulateTransitionEnd(f)
                    } else p(r).removeClass(V), p(l).addClass(V), this._isSliding = !1, p(this._element).trigger(d);
                    h && this.cycle()
                }
                ...
                return this.each(function () {
                    ...
                    if (t || (t = new s(this, e), p(this).data($, t)), "number" == typeof n) t.to(n);
                ...
                if (e) {
                    ...
                    if (i && p(i).hasClass(q)) {
                        ...
                        o && (n.interval = !1), s._jQueryInterface.call(p(i), n), o && p(i).data($).to(o), t.preventDefault()
                    }
                }
            }, r(s, null, [{
                key: "VERSION",
    ...
    p(document).on(B.CLICK_DATA_API, ot, at._dataApiClickHandler), p(window).on(B.LOAD_DATA_API, function () {
        for (var t = [].slice.call(document.querySelectorAll(st)), e = 0, i = t.length; e < i; e++) {
            var n = p(t[e]);
            at._jQueryInterface.call(n, n.data())
        }
    }), p.fn[D] = at._jQueryInterface, p.fn[D].Constructor = at, p.fn[D].noConflict = function () {
    ...
    var lt = "collapse",
        ...
        St = function () {
            function a(e, t) {
                ...
                for (var i = [].slice.call(document.querySelectorAll(wt)), n = 0, o = i.length; n < o; n++) {
                    var s = i[n],
            ...
            return t.toggle = function () {
                ...
                var t, e, i = this;
                if (!this._isTransitioning && !p(this._element).hasClass(gt) && (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(xt)).filter(function (t) {
                    ...
                    if (p(this._element).trigger(n), !n.isDefaultPrevented()) {
                        ...
                        p(this._element).removeClass(mt).addClass(vt), this._element.style[o] = 0, this._triggerArray.length && p(this._triggerArray).removeClass(bt).attr("aria-expanded", !0), this.setTransitioning(!0);
                        ...
                        p(this._element).one(g.TRANSITION_END, function () {
                            p(i._element).removeClass(vt).addClass(mt).addClass(gt), i._element.style[o] = "", i.setTransitioning(!1), p(i._element).trigger(pt.SHOWN)
                ...
                if (!this._isTransitioning && p(this._element).hasClass(gt)) {
                    ...
                    if (p(this._element).trigger(e), !e.isDefaultPrevented()) {
                        ...
                        this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", g.reflow(this._element), p(this._element).addClass(vt).removeClass(mt).removeClass(gt);
                        var n = this._triggerArray.length;
                        if (0 < n)
                            for (var o = 0; o < n; o++) {
                                var s = this._triggerArray[o],
                                    r = g.getSelectorFromElement(s);
                                if (null !== r) p([].slice.call(document.querySelectorAll(r))).hasClass(gt) || p(s).addClass(bt).attr("aria-expanded", !1)
                            }
                        this.setTransitioning(!0);
                        this._element.style[i] = "";
                        var a = g.getTransitionDurationFromElement(this._element);
                        p(this._element).one(g.TRANSITION_END, function () {
                            t.setTransitioning(!1), p(t._element).removeClass(vt).addClass(mt).trigger(pt.HIDDEN)
                ...
                return (t = l({}, ut, t)).toggle = Boolean(t.toggle), g.typeCheckConfig(lt, t, ft), t
    ...
    }), p.fn[lt] = St._jQueryInterface, p.fn[lt].Constructor = St, p.fn[lt].noConflict = function () {
        return p.fn[lt] = dt, St._jQueryInterface
    };
    for (var kt = "undefined" != typeof window && "undefined" != typeof document, Tt = ["Edge", "Trident", "Firefox"], Ct = 0, It = 0; It < Tt.length; It += 1)
        if (kt && 0 <= navigator.userAgent.indexOf(Tt[It])) {
            Ct = 1;
            break
        } var Et = kt && window.Promise ? function (t) {
        var e = !1;
        return function () {
    ...
    function Ft(t) {
        ...
        var n = i && i.nodeName;
        return n && "BODY" !== n && "HTML" !== n ? -1 !== ["TH", "TD", "TABLE"].indexOf(i.nodeName) && "static" === At(i, "position") ? Ft(i) : i : t ? t.ownerDocument.documentElement : document.documentElement
    }
    ...
    function Rt(t, e) {
        ...
        if (t !== l && e !== l || n.contains(o)) return "BODY" === (a = (r = l).nodeName) || "HTML" !== a && Ft(r.firstElementChild) !== r ? Ft(l) : l;
        var c = zt(t);
    ...
    function Wt(t) {
        ...
        return {
            height: jt("Height", e, i, n),
            width: jt("Width", e, i, n)
        }
    }
    ...
    function Qt(t, e, i) {
        ...
        if (u.marginTop = 0, u.marginLeft = 0, !o && s) {
            ...
            u.top -= h - f, u.bottom -= h - f, u.left -= d - p, u.right -= d - p, u.marginTop = f, u.marginLeft = p
        }
    ...
    function Gt(t, e, i, n, o) {
        ...
        if ("viewport" === n) r = function (t, e) {
            ...
            var l = void 0;
            "scrollParent" === n ? "BODY" === (l = Dt(Pt(e))).nodeName && (l = t.ownerDocument.documentElement) : l = "window" === n ? t.ownerDocument.documentElement : n;
            var c = Qt(l, a, s);
    ...
    function oe(t, i, e) {
        return (void 0 === e ? t : t.slice(0, function (t, e, i) {
            ...
            t.enabled && Mt(e) && (i.offsets.popper = Yt(i.offsets.popper), i.offsets.reference = Yt(i.offsets.reference), i = e(i, t))
        }), i
    }
    ...
    function le(t, e, i, n) {
        ...
        return function t(e, i, n, o) {
            ...
            r.addEventListener(i, n, {
                passive: !0
            }), s || t(Dt(r.parentNode), i, n, o), o.push(r)
                ...
                offset: {
                    ...
                    fn: function (t, e) {
                        var i = e.offset,
                            ...
                            a = n.split("-")[0],
                            l = void 0;
                        return l = he(+i) ? [+i, 0] : xe(i, s, r, a), "left" === a ? (s.top += l[0], s.left -= l[1]) : "right" === a ? (s.top += l[0], s.left += l[1]) : "top" === a ? (s.left += l[0], s.top -= l[1]) : "bottom" === a && (s.left += l[0], s.top += l[1]), t.popper = s, t
                    },
                    offset: 0
                },
                preventOverflow: {
                    ...
                    fn: function (t, n) {
                        ...
                        var c = n.priority,
                            ...
                            d = {
                                primary: function (t) {
                                    var e = h[t];
                                    return h[t] < l[t] && !n.escapeWithReference && (e = Math.max(h[t], l[t])), Vt({}, t, e)
                                },
                                secondary: function (t) {
                                    var e = "right" === t ? "left" : "top",
                                        i = h[e];
                                    return h[t] > l[t] && !n.escapeWithReference && (i = Math.min(h[e], l[t] - ("right" === t ? h.width : h.height))), Vt({}, e, i)
                                }
                            };
                ...
                arrow: {
                    ...
                    fn: function (t, e) {
                        ...
                        var o = t.placement.split("-")[0],
                            ...
                            f = l ? "bottom" : "right",
                            p = te(n)[c];
                        a[f] - p < r[d] && (t.offsets.popper[d] -= r[d] - (a[f] - p)), a[d] + p > r[f] && (t.offsets.popper[d] += a[d] + p - r[f]), t.offsets.popper = Yt(t.offsets.popper);
                        var g = a[d] + a[c] / 2 - p / 2,
                            m = At(t.instance.popper),
                            v = parseFloat(m["margin" + h], 10),
                            b = parseFloat(m["border" + h + "Width"], 10),
                            y = g - t.offsets.popper[d] - v - b;
                        return y = Math.max(Math.min(r[c] - p, y), 0), t.arrowElement = n, t.offsets.arrow = (Vt(i = {}, d, Math.round(y)), Vt(i, u, ""), i), t
                    },
                    element: "[x-arrow]"
                },
                flip: {
                    ...
                    fn: function (p, g) {
                        ...
                        return _.forEach(function (t, e) {
                            ...
                            var i, n = p.offsets.popper,
                                ...
                                f = !!g.flipVariations && (u && "start" === y && a || u && "end" === y && l || !u && "start" === y && c || !u && "end" === y && h);
                            (r || d || f) && (p.flipped = !0, (r || d) && (v = _[e + 1]), f && (y = "end" === (i = y) ? "start" : "start" === i ? "end" : i), p.placement = v + (y ? "-" + y : ""), p.offsets.popper = Ut({}, p.offsets.popper, ie(p.instance.popper, p.offsets.reference, p.placement)), p = oe(p.instance.modifiers, p, "flip"))
                        }), p
                    },
                    behavior: "flip",
                    padding: 5,
                ...
                computeStyle: {
                    ...
                    fn: function (t, e) {
                        ...
                        var r = void 0 !== s ? s : e.gpuAcceleration,
                            ...
                            p = void 0,
                            g = void 0;
                        if (g = "bottom" == d ? "HTML" === a.nodeName ? -a.clientHeight + h.bottom : -l.height + h.bottom : h.top, p = "right" == u ? "HTML" === a.nodeName ? -a.clientWidth + h.right : -l.width + h.right : h.left, r && f) c[f] = "translate3d(" + p + "px, " + g + "px, 0)", c[d] = 0, c[u] = 0, c.willChange = "transform";
                        else {
                            var m = "bottom" == d ? -1 : 1,
                                v = "right" == u ? -1 : 1;
                        ...
                        return t.attributes = Ut({}, b, t.attributes), t.styles = Ut({}, c, t.styles), t.arrowStyles = Ut({}, t.offsets.arrow, t.arrowStyles), t
                    },
                    gpuAcceleration: !0,
                    x: "bottom",
                    y: "right"
    ...
    function ke(t, e) {
        ...
        }(this, ke), this.scheduleUpdate = function () {
            return requestAnimationFrame(i.update)
        }, this.update = Et(this.update.bind(this)), this.options = Ut({}, ke.Defaults, n), this.state = {
            isDestroyed: !1,
            isCreated: !1,
            scrollParents: []
        }, this.reference = t && t.jquery ? t[0] : t, this.popper = e && e.jquery ? e[0] : e, this.options.modifiers = {}, Object.keys(Ut({}, ke.Defaults.modifiers, n.modifiers)).forEach(function (t) {
            i.options.modifiers[t] = Ut({}, ke.Defaults.modifiers[t] || {}, n.modifiers ? n.modifiers[t] : {})
    ...
    Se.Utils = ("undefined" != typeof window ? window : global).PopperUtils, Se.placements = ge, Se.Defaults = we;
    var Te = "dropdown",
        Ce = "bs.dropdown",
        Ie = "." + Ce,
        Ee = ".data-api",
        ...
        Ze = function () {
            ...
            return t.toggle = function () {
                    ...
                    if (c._clearMenus(), !e) {
                        ...
                        if (p(t).trigger(n), !n.isDefaultPrevented()) {
                            if (!this._inNavbar) {
                                ...
                                var o = this._element;
                                "parent" === this._config.reference ? o = t : g.isElement(this._config.reference) && (o = this._config.reference, void 0 !== this._config.reference.jquery && (o = this._config.reference[0])), "scrollParent" !== this._config.boundary && p(t).addClass(Re), this._popper = new Se(o, this._menu, this._getPopperConfig())
                            }
                            "ontouchstart" in document.documentElement && 0 === p(t).closest(We).length && p(document.body).children().on("mouseover", null, p.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass($e), p(t).toggleClass($e).trigger(p.Event(Pe.SHOWN, i))
                        }
                    }
                }
            }, t.show = function () {
                if (!(this._element.disabled || p(this._element).hasClass(De) || p(this._menu).hasClass($e))) {
                    var t = {
                            relatedTarget: this._element
                        },
                        e = p.Event(Pe.SHOW, t),
                        i = c._getParentFromElement(this._element);
                    p(i).trigger(e), e.isDefaultPrevented() || (p(this._menu).toggleClass($e), p(i).toggleClass($e).trigger(p.Event(Pe.SHOWN, t)))
                }
            }, t.hide = function () {
                if (!this._element.disabled && !p(this._element).hasClass(De) && p(this._menu).hasClass($e)) {
                    var t = {
                        ...
                        e = p.Event(Pe.HIDE, t),
                        i = c._getParentFromElement(this._element);
                    p(i).trigger(e), e.isDefaultPrevented() || (p(this._menu).toggleClass($e), p(i).toggleClass($e).trigger(p.Event(Pe.HIDDEN, t)))
                }
            }, t.dispose = function () {
                p.removeData(this._element, Ce), p(this._element).off(Ie), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
            }, t.update = function () {
                ...
                return t = l({}, this.constructor.Default, p(this._element).data(), t), g.typeCheckConfig(Te, t, this.constructor.DefaultType), t
                ...
                var t = p(this._element.parentNode),
                    e = Ue;
                return t.hasClass(Oe) ? (e = qe, p(this._menu).hasClass(ze) && (e = Ve)) : t.hasClass(Le) ? e = Xe : t.hasClass(Fe) ? e = Qe : p(this._menu).hasClass(ze) && (e = Ye), e
                ...
                if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
                    for (var e = [].slice.call(document.querySelectorAll(Ne)), i = 0, n = e.length; i < n; i++) {
                        ...
                        if (t && "click" === t.type && (r.clickEvent = t), s) {
                            var a = s._menu;
                            if (p(o).hasClass($e) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && p.contains(o, t.target))) {
                                var l = p.Event(Pe.HIDE, r);
                                p(o).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), e[i].setAttribute("aria-expanded", "false"), p(a).removeClass($e), p(o).removeClass($e).trigger(p.Event(Pe.HIDDEN, r)))
                            }
                        }
                    }
                ...
                if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || p(t.target).closest(je).length)) : Ae.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !p(this).hasClass(De))) {
    ...
    p(document).on(Pe.KEYDOWN_DATA_API, Ne, Ze._dataApiKeydownHandler).on(Pe.KEYDOWN_DATA_API, je, Ze._dataApiKeydownHandler).on(Pe.CLICK_DATA_API + " " + Pe.KEYUP_DATA_API, Ze._clearMenus).on(Pe.CLICK_DATA_API, Ne, function (t) {
        t.preventDefault(), t.stopPropagation(), Ze._jQueryInterface.call(p(this), "toggle")
    }).on(Pe.CLICK_DATA_API, He, function (t) {
        t.stopPropagation()
    }), p.fn[Te] = Ze._jQueryInterface, p.fn[Te].Constructor = Ze, p.fn[Te].noConflict = function () {
        ...
        bi = function () {
            ...
            return t.toggle = function (t) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    ...
                    var i = p.Event(si.SHOW, {
                        relatedTarget: t
                    });
                    p(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), p(this._element).on(si.CLICK_DISMISS, gi, function (t) {
                        return e.hide(t)
                ...
                if (t && t.preventDefault(), this._isShown && !this._isTransitioning) {
                    ...
                    if (p(this._element).trigger(i), this._isShown && !i.isDefaultPrevented()) {
                        ...
                        if (n && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), p(document).off(si.FOCUSIN), p(this._element).removeClass(di), p(this._element).off(si.CLICK_DISMISS), p(this._dialog).off(si.MOUSEDOWN_DISMISS), n) {
                ...
                [window, this._element, this._dialog].forEach(function (t) {
                    return p(t).off(ei)
                }), p(document).off(si.FOCUSIN), p.removeData(this._element, ti), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
                ...
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), p(this._dialog).hasClass(ri) ? this._dialog.querySelector(fi).scrollTop = 0 : this._element.scrollTop = 0, i && g.reflow(this._element), p(this._element).addClass(di), this._config.focus && this._enforceFocus();

                function n() {
                    e._config.focus && e._element.focus(), e._isTransitioning = !1, p(e._element).trigger(o)
                }
                var o = p.Event(si.SHOWN, {
                    relatedTarget: t
                });
                if (i) {
                ...
                var e = this;
                p(document).off(si.FOCUSIN).on(si.FOCUSIN, function (t) {
                    document !== t.target && e._element !== t.target && 0 === p(e._element).has(t.target).length && e._element.focus()
                })
            }, t._setEscapeEvent = function () {
                var e = this;
                this._isShown && this._config.keyboard ? p(this._element).on(si.KEYDOWN_DISMISS, function (t) {
                    27 === t.which && (t.preventDefault(), e.hide())
                }) : this._isShown || p(this._element).off(si.KEYDOWN_DISMISS)
            }, t._setResizeEvent = function () {
                var e = this;
                this._isShown ? p(window).on(si.RESIZE, function (t) {
                    return e.handleUpdate(t)
                }) : p(window).off(si.RESIZE)
            }, t._hideModal = function () {
                var t = this;
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function () {
                    p(document.body).removeClass(ci), t._resetAdjustments(), t._resetScrollbar(), p(t._element).trigger(si.HIDDEN)
                })
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = li, i && this._backdrop.classList.add(i), p(this._backdrop).appendTo(document.body), p(this._element).on(si.CLICK_DISMISS, function (t) {
                            e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && ("static" === e._config.backdrop ? e._element.focus() : e.hide())
                        }), i && g.reflow(this._backdrop), p(this._backdrop).addClass(di), !t) return;
                    if (!i) return void t();
                ...
                return this.each(function () {
                    ...
                    if (t || (t = new o(this, e), p(this).data(ti, t)), "string" == typeof i) {
                        if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                        t[i](n)
    ...
    }), p.fn[Je] = bi._jQueryInterface, p.fn[Je].Constructor = bi, p.fn[Je].noConflict = function () {
        return p.fn[Je] = ii, bi._jQueryInterface
    };
    var yi = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"],
        _i = {
        ...
        for (var i = (new window.DOMParser).parseFromString(t, "text/html"), r = Object.keys(s), a = [].slice.call(i.body.querySelectorAll("*")), n = function (t) {
                ...
                n.forEach(function (t) {
                    ! function (t, e) {
                        ...
                        if (-1 !== e.indexOf(i)) return -1 === yi.indexOf(i) || Boolean(t.nodeValue.match(xi) || t.nodeValue.match(wi));
            ...
            return t.enable = function () {
                ...
                if (this._isEnabled)
                    if (t) {
                        ...
                        if (p(this.getTipElement()).hasClass(Ri)) return void this._leave(null, this);
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    o.setAttribute("id", s), this.element.setAttribute("aria-describedby", s), this.setContent(), this.config.animation && p(o).addClass(zi);
                    ...
                    p(o).data(this.constructor.DATA_KEY, this), p.contains(this.element.ownerDocument.documentElement, this.tip) || p(o).appendTo(l), p(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new Se(this.element, o, {
                        placement: a,
                        modifiers: {
                            offset: this._getOffset(),
                            flip: {
                    ...
                    }), p(o).addClass(Ri), "ontouchstart" in document.documentElement && p(document.body).children().on("mouseover", null, p.noop);
                    var c = function () {
                        e.config.animation && e._fixTransition();
                        var t = e._hoverState;
                        e._hoverState = null, p(e.element).trigger(e.constructor.Event.SHOWN), t === Li && e._leave(null, e)
                    };
                ...
                function e() {
                    i._hoverState !== Oi && n.parentNode && n.parentNode.removeChild(n), i._cleanTipClass(), i.element.removeAttribute("aria-describedby"), p(i.element).trigger(i.constructor.Event.HIDDEN), null !== i._popper && i._popper.destroy(), t && t()
                }
                var i = this,
                    n = this.getTipElement(),
                    o = p.Event(this.constructor.Event.HIDE);
                if (p(this.element).trigger(o), !o.isDefaultPrevented()) {
                    if (p(n).removeClass(Ri), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger[Bi] = !1, this._activeTrigger[Wi] = !1, this._activeTrigger[ji] = !1, p(this.tip).hasClass(zi)) {
                ...
                this.setElementContent(p(t.querySelectorAll(Ni)), this.getTitle()), p(t).removeClass(zi + " " + Ri)
            }, t.setElementContent = function (t, e) {
                "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = Si(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e)) : t.text(e) : this.config.html ? p(e).parent().is(t) || t.empty().append(e) : t.text(p(e).text())
            }, t.getTitle = function () {
                ...
                var i = this.constructor.DATA_KEY;
                (e = e || p(t.currentTarget).data(i)) || (e = new this.constructor(t.currentTarget, this._getDelegateConfig()), p(t.currentTarget).data(i, e)), t && (e._activeTrigger["focusout" === t.type ? Wi : ji] = !1), e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = Li, e.config.delay && e.config.delay.hide ? e._timeout = setTimeout(function () {
                ...
                return Object.keys(e).forEach(function (t) {
                    ...
                    show: t.delay,
                    hide: t.delay
                }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), g.typeCheckConfig(ki, t, this.constructor.DefaultType), t.sanitize && (t.template = Si(t.template, t.whiteList, t.sanitizeFn)), t
                ...
                null === t.getAttribute("x-placement") && (p(t).removeClass(zi), this.config.animation = !1, this.hide(), this.show(), this.config.animation = e)
            }, n._jQueryInterface = function (i) {
                return this.each(function () {
                    var t = p(this).data(Ti),
                        e = "object" == typeof i && i;
                    if ((t || !/dispose|hide/.test(i)) && (t || (t = new n(this, e), p(this).data(Ti, t)), "string" == typeof i)) {
                        if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                        t[i]()
                    }
                })
    ...
    p.fn[ki] = Vi._jQueryInterface, p.fn[ki].Constructor = Vi, p.fn[ki].noConflict = function () {
        ...
        rn = function (t) {
            ...
            return o.isWithContent = function () {
                ...
                return this.each(function () {
                    ...
                    if ((t || !/dispose|hide/.test(i)) && (t || (t = new n(this, e), p(this).data(Yi, t)), "string" == typeof i)) {
                        if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                        t[i]()
                    }
                })
    ...
    p.fn[Ui] = rn._jQueryInterface, p.fn[Ui].Constructor = rn, p.fn[Ui].noConflict = function () {
    ...
    var an = "scrollspy",
        ...
        Cn = function () {
            function i(t, e) {
                var i = this;
                this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + bn + "," + this._config.target + " " + _n + "," + this._config.target + " " + wn, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, p(this._scrollElement).on(fn.SCROLL, function (t) {
                    return i._process(t)
            ...
            return t.refresh = function () {
                ...
                i.hasClass(pn) ? (i.closest(xn).find(Sn).addClass(gn), i.addClass(gn)) : (i.addClass(gn), i.parents(vn).prev(bn + ", " + _n).addClass(gn), i.parents(vn).prev(yn).children(bn).addClass(gn)), p(this._scrollElement).trigger(fn.ACTIVATE, {
                    relatedTarget: e
                })
            }, t._clear = function () {
                ...
                return this.each(function () {
                    ...
                    if (t || (t = new i(this, "object" == typeof e && e), p(this).data(ln, t)), "string" == typeof e) {
                        if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                        t[e]()
                    }
                })
    ...
    }), p.fn[an] = Cn._jQueryInterface, p.fn[an].Constructor = Cn, p.fn[an].noConflict = function () {
    ...
    var In = "bs.tab",
        ...
        Bn = function () {
            ...
            return t.show = function () {
                var i = this;
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(Dn) || p(this._element).hasClass($n))) {
                    var t, n, e = p(this._element).closest(zn)[0],
                        o = g.getSelectorFromElement(this._element);
                    if (e) {
                        var s = "UL" === e.nodeName || "OL" === e.nodeName ? Nn : Rn;
                        n = (n = p.makeArray(p(e).find(s)))[n.length - 1]
                    }
                    var r = p.Event(An.HIDE, {
                            relatedTarget: this._element
                        }),
                        a = p.Event(An.SHOW, {
                            relatedTarget: n
                ...
                var o = this,
                    s = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? p(e).children(Rn) : p(e).find(Nn))[0],
                    r = i && s && p(s).hasClass(On);
                if (s && r) {
                    var a = g.getTransitionDurationFromElement(s);
                    p(s).removeClass(Ln).one(g.TRANSITION_END, n).emulateTransitionEnd(a)
                } else n()
            }, t._transitionComplete = function (t, e, i) {
                if (e) {
                    p(e).removeClass(Dn);
                    var n = p(e.parentNode).find(Wn)[0];
                    n && p(n).removeClass(Dn), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)
                }
                if (p(t).addClass(Dn), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), g.reflow(t), t.classList.contains(On) && t.classList.add(Ln), t.parentNode && p(t.parentNode).hasClass(Pn)) {
                ...
                return this.each(function () {
                    var t = p(this),
                        e = t.data(In);
                    if (e || (e = new n(this), t.data(In, e)), "string" == typeof i) {
    ...
    }), p.fn.tab = Bn._jQueryInterface, p.fn.tab.Constructor = Bn, p.fn.tab.noConflict = function () {
    ...
    var qn = "toast",
        ...
        io = function () {
            ...
            return t.show = function () {
                var t = this;
                p(this._element).trigger(Xn.SHOW), this._config.animation && this._element.classList.add(Qn);

                function e() {
                    t._element.classList.remove(Zn), t._element.classList.add(Gn), p(t._element).trigger(Xn.SHOWN), t._config.autohide && t.hide()
                }
                ...
                var e = this;
                this._element.classList.contains(Gn) && (p(this._element).trigger(Xn.HIDE), t ? this._close() : this._timeout = setTimeout(function () {
                    e._close()
                }, this._config.delay))
            }, t.dispose = function () {
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Gn) && this._element.classList.remove(Gn), p(this._element).off(Xn.CLICK_DISMISS), p.removeData(this._element, Vn), this._element = null, this._config = null
            }, t._getConfig = function (t) {
                return t = l({}, to, p(this._element).data(), "object" == typeof t && t ? t : {}), g.typeCheckConfig(qn, t, this.constructor.DefaultType), t
            }, t._setListeners = function () {
                var t = this;
                ...
                return this.each(function () {
                    var t = p(this),
                        e = t.data(Vn);
                    if (e || (e = new n(this, "object" == typeof i && i), t.data(Vn, e)), "string" == typeof i) {
                        if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
                        e[i](this)
                    }
                })
    ...
    p.fn[qn] = io._jQueryInterface, p.fn[qn].Constructor = io, p.fn[qn].noConflict = function () {
        ...
        }(), t.Util = g, t.Alert = m, t.Button = P, t.Carousel = at, t.Collapse = St, t.Dropdown = Ze, t.Modal = bi, t.Popover = rn, t.Scrollspy = Cn, t.Tab = Bn, t.Toast = io, t.Tooltip = Vi, Object.defineProperty(t, "__esModule", {
            value: !0
        })
}),
function (t, e) {
    ...
    var o = {
        ...
        hsv2hsl: function (t) {
            var e, i, n = t[0],
                o = t[1] / 100,
                s = t[2] / 100;
            return e = o * s, [n, 100 * (e = (e /= (i = (2 - o) * s) <= 1 ? i : 2 - i) || 0), 100 * (i /= 2)]
        },
        hsv2hwb: function (t) {
            return i(u(t))
        },
    ...
    function s(t) {
        var e, i, n = t[0] / 255,
            ...
            a = Math.max(n, o, s),
            l = a - r;
        return a == r ? e = 0 : n == a ? e = (o - s) / l : o == a ? e = 2 + (s - n) / l : s == a && (e = 4 + (n - o) / l), (e = Math.min(60 * e, 360)) < 0 && (e += 360), i = (r + a) / 2, [e, 100 * (a == r ? 0 : i <= .5 ? l / (a + r) : l / (2 - a - r)), 100 * i]
    }
    ...
    function e(t) {
        var e, i, n = t[0],
            ...
            a = Math.max(n, o, s),
            l = a - r;
        return i = 0 == a ? 0 : l / a * 1e3 / 10, a == r ? e = 0 : n == a ? e = (o - s) / l : o == a ? e = 2 + (s - n) / l : s == a && (e = 4 + (n - o) / l), (e = Math.min(60 * e, 360)) < 0 && (e += 360), [e, i, a / 255 * 1e3 / 10]
    }
    ...
    function i(t) {
        var e = t[0],
            i = t[1],
            n = t[2];
        return [s(t)[0], 1 / 255 * Math.min(e, Math.min(i, n)) * 100, 100 * (n = 1 - 1 / 255 * Math.max(e, Math.max(i, n)))]
    }
    ...
    function d(t) {
        ...
        e = 2 * l - (i = l < .5 ? l * (1 + a) : l + a - l * a), o = [0, 0, 0];
        for (var c = 0; c < 3; c++)(n = r + 1 / 3 * -(c - 1)) < 0 && n++, 1 < n && n--, s = 6 * n < 1 ? e + 6 * (i - e) * n : 2 * n < 1 ? i : 3 * n < 2 ? e + (i - e) * (2 / 3 - n) * 6 : e, o[c] = 255 * s;
        return o
    }
    ...
    function y(t) {
        var e, i, n, o, s = t[0],
            r = t[1],
            a = t[2];
        return o = s <= 8 ? (i = 100 * s / 903.3) / 100 * 7.787 + 16 / 116 : (i = 100 * Math.pow((s + 16) / 116, 3), Math.pow(i / 100, 1 / 3)), [e = e / 95.047 <= .008856 ? e = 95.047 * (r / 500 + o - 16 / 116) / 7.787 : 95.047 * Math.pow(r / 500 + o, 3), i, n = n / 108.883 <= .008859 ? n = 108.883 * (o - a / 200 - 16 / 116) / 7.787 : 108.883 * Math.pow(o - a / 200, 3)]
    }
    ...
    var D = C,
        ...
        O = {
            ...
            hexString: function (t, e) {
                ...
                return "#" + W(t[0]) + W(t[1]) + W(t[2]) + (0 <= e && e < 1 ? W(Math.round(255 * e)) : "")
            },
            ...
            percentString: function (t, e) {
                return e < 1 || t[3] && t[3] < 1 ? N(t, e) : "rgb(" + Math.round(t[0] / 255 * 100) + "%, " + Math.round(t[1] / 255 * 100) + "%, " + Math.round(t[2] / 255 * 100) + "%)"
            },
            percentaString: N,
    ...
    function L(t) {
        if (t) {
            ...
            if (n) {
                ...
                for (o = n[2], n = n[1], s = 0; s < e.length; s++) e[s] = parseInt(n.slice(2 * s, 2 * s + 2), 16);
                ...
                for (s = 0; s < e.length; s++) e[s] = Math.round(2.55 * parseFloat(n[s + 1]));
                i = parseFloat(n[4])
            } else if (n = t.match(/(\w+)/)) {
    ...
    var V = function (t) {
        return t instanceof V ? t : this instanceof V ? (this.valid = !1, this.values = {
            ...
            cmyk: [0, 0, 0, 0],
            alpha: 1
        }, void("string" == typeof t ? (e = O.getRgba(t)) ? this.setValues("rgb", e) : (e = O.getHsla(t)) ? this.setValues("hsl", e) : (e = O.getHwb(t)) && this.setValues("hwb", e) : "object" == typeof t && (void 0 !== (e = t).r || void 0 !== e.red ? this.setValues("rgb", e) : void 0 !== e.l || void 0 !== e.lightness ? this.setValues("hsl", e) : void 0 !== e.v || void 0 !== e.value ? this.setValues("hsv", e) : void 0 !== e.w || void 0 !== e.whiteness ? this.setValues("hwb", e) : void 0 === e.c && void 0 === e.cyan || this.setValues("cmyk", e)))) : new V(t);
        var e
    };
    V.prototype = {
        isValid: function () {
        ...
        mix: function (t, e) {
            var i = t,
                ...
                a = 1 - r;
            return this.rgb(r * this.red() + a * i.red(), r * this.green() + a * i.green(), r * this.blue() + a * i.blue()).alpha(this.alpha() * n + i.alpha() * (1 - n))
        },
        toJSON: function () {
            return this.rgb()
        },
        clone: function () {
            var t, e, i = new V,
                n = this.values,
                o = i.values;
            for (var s in n) n.hasOwnProperty(s) && (t = n[s], "[object Array]" === (e = {}.toString.call(t)) ? o[s] = t.slice(0) : "[object Number]" === e ? o[s] = t : console.error("unexpected color value:", t));
            return i
        }
    }, V.prototype.spaces = {
        rgb: ["red", "green", "blue"],
        ...
        for (i = 0; i < t.length; i++) n = Math.max(0, Math.min(r[t][i], o[t][i])), o[t][i] = Math.round(n);
        ...
        X = {
            ...
            each: function (t, e, i, n) {
                ...
                if (X.isArray(t))
                    ...
                    for (s = (r = Object.keys(t)).length, o = 0; o < s; o++) e.call(i, t[r[o]], r[o])
            },
            ...
            clone: function (t) {
                ...
                if (X.isObject(t)) {
                    for (var e = {}, i = Object.keys(t), n = i.length, o = 0; o < n; ++o) e[i[o]] = X.clone(t[i[o]]);
                    return e
                }
                return t
            },
            _merger: function (t, e, i, n) {
                var o = e[t],
                    s = i[t];
                X.isObject(o) && X.isObject(s) ? X.merge(o, s, n) : e[t] = X.clone(s)
            },
            _mergerIf: function (t, e, i) {
                var n = e[t],
                    o = i[t];
                X.isObject(n) && X.isObject(o) ? X.mergeIf(n, o) : e.hasOwnProperty(t) || (e[t] = X.clone(o))
            },
            merge: function (t, e, i) {
                var n, o, s, r, a, l = X.isArray(e) ? e : [e],
                    c = l.length;
                if (!X.isObject(t)) return t;
                for (n = (i = i || {}).merger || X._merger, o = 0; o < c; ++o)
                    if (e = l[o], X.isObject(e))
                        for (a = 0, r = (s = Object.keys(e)).length; a < r; ++a) n(s[a], t, e, i);
                return t
            },
            ...
            extend: function (i) {
                for (var t = function (t, e) {
                        i[e] = t
                    }, e = 1, n = arguments.length; e < n; ++e) X.each(arguments[e], t);
                return i
            },
            inherits: function (t) {
                function e() {
                ...
                return e.prototype = i.prototype, n.prototype = new e, n.extend = X.inherits, t && X.extend(n.prototype, t), n.__super__ = i.prototype, n
            }
        },
        Q = X;
    ...
    var Z = Math.PI,
        ...
        ot = {
            ...
            roundedRect: function (t, e, i, n, o, s) {
                if (s) {
                    var r = Math.min(s, o / 2, n / 2),
                        ...
                        c = e + n - r,
                        h = i + o - r;
                    t.moveTo(e, l), a < c && l < h ? (t.arc(a, l, r, -Z, -et), t.arc(c, l, r, -et, 0), t.arc(c, h, r, 0, et), t.arc(a, h, r, et, Z)) : a < c ? (t.moveTo(a, i), t.arc(c, l, r, -et, et), t.arc(a, l, r, et, Z + et)) : l < h ? (t.arc(a, l, r, -Z, 0), t.arc(a, h, r, 0, Z)) : t.arc(a, l, r, -Z, Z), t.closePath(), t.moveTo(e, i)
                } else t.rect(e, i, n, o)
            },
            drawPoint: function (t, e, i, n, o, s) {
                var r, a, l, c, h, d = (s || 0) * J;
                    ...
                    if (!(isNaN(i) || i <= 0)) {
                        switch (t.beginPath(), e) {
                            default:
                                ...
                                break;
                            case "triangle":
                                t.moveTo(n + Math.sin(d) * i, o - Math.cos(d) * i), d += nt, t.lineTo(n + Math.sin(d) * i, o - Math.cos(d) * i), d += nt, t.lineTo(n + Math.sin(d) * i, o - Math.cos(d) * i), t.closePath();
                                break;
                            case "rectRounded":
                                c = i - (h = .516 * i), a = Math.cos(d + it) * c, l = Math.sin(d + it) * c, t.arc(n - a, o - l, h, d - Z, d - et), t.arc(n + l, o - a, h, d - et, d), t.arc(n + a, o + l, h, d, d + et), t.arc(n - l, o + a, h, d + et, d + Z), t.closePath();
                                break;
                            case "rect":
                                if (!s) {
                                ...
                                d += it;
                            case "rectRot":
                                a = Math.cos(d) * i, l = Math.sin(d) * i, t.moveTo(n - a, o - l), t.lineTo(n + l, o - a), t.lineTo(n + a, o + l), t.lineTo(n - l, o + a), t.closePath();
                                break;
                            case "crossRot":
                                d += it;
                            case "cross":
                                a = Math.cos(d) * i, l = Math.sin(d) * i, t.moveTo(n - a, o - l), t.lineTo(n + a, o + l), t.moveTo(n + l, o - a), t.lineTo(n - l, o + a);
                                break;
                            case "star":
                                a = Math.cos(d) * i, l = Math.sin(d) * i, t.moveTo(n - a, o - l), t.lineTo(n + a, o + l), t.moveTo(n + l, o - a), t.lineTo(n - l, o + a), d += it, a = Math.cos(d) * i, l = Math.sin(d) * i, t.moveTo(n - a, o - l), t.lineTo(n + a, o + l), t.moveTo(n + l, o - a), t.lineTo(n - l, o + a);
                                break;
                            case "line":
                                a = Math.cos(d) * i, l = Math.sin(d) * i, t.moveTo(n - a, o - l), t.lineTo(n + a, o + l);
                                break;
                            case "dash":
                                t.moveTo(n, o), t.lineTo(n + Math.cos(d) * i, o + Math.sin(d) * i)
                        }
                        t.fill(), t.stroke()
                    }
            ...
            lineTo: function (t, e, i, n) {
                ...
                if (o) {
                    ...
                    } else "after" === o && !n || "after" !== o && n ? t.lineTo(e.x, i.y) : t.lineTo(i.x, e.y);
                    t.lineTo(i.x, i.y)
        ...
        st = ot;
    Q.clear = ot.clear, Q.drawRoundedRectangle = function (t) {
    ...
    var at = rt,
        ...
        ct = {
            ...
            toPadding: function (t) {
                var e, i, n, o;
                return Q.isObject(t) ? (e = +t.top || 0, i = +t.right || 0, n = +t.bottom || 0, o = +t.left || 0) : e = i = n = o = +t || 0, {
                    top: e,
                    right: i,
                    bottom: n,
                    left: o,
            ...
            _parseFont: function (t) {
                var e, i = at.global,
                    ...
                    o = {
                        ...
                        lineHeight: Q.options.toLineHeight(lt(t.lineHeight, i.defaultLineHeight), n),
                        size: n,
                        style: lt(t.fontStyle, i.defaultFontStyle),
                        weight: null,
                        string: ""
                    };
                return o.string = !(e = o) || Q.isNullOrUndef(e.size) || Q.isNullOrUndef(e.family) ? null : (e.style ? e.style + " " : "") + (e.weight ? e.weight + " " : "") + e.size + "px " + e.family, o
            },
            resolve: function (t, e, i) {
                var n, o, s;
                for (n = 0, o = t.length; n < o; ++n)
                    if (void 0 !== (s = t[n]) && (void 0 !== e && "function" == typeof s && (s = s(e)), void 0 !== i && Q.isArray(s) && (s = s[i]), void 0 !== s)) return s
            }
        },
        ht = Q,
        dt = G,
    ...
    ht.extend(pt.prototype, {
        ...
        transition: function (t) {
            ...
            return i && 1 !== t ? (o = o || (e._view = {}), function (t, e, i, n) {
                var o, s, r, a, l, c, h, d, u, f = Object.keys(i);
                for (o = 0, s = f.length; o < s; ++o)
                    if (c = i[r = f[o]], e.hasOwnProperty(r) || (e[r] = c), (a = e[r]) !== c && "_" !== r[0]) {
                        if (t.hasOwnProperty(r) || (t[r] = a), (h = typeof c) == typeof (l = t[r]))
                            if ("string" == h) {
    ...
    var bt = {
            ...
            addAnimation: function (t, e, i, n) {
                var o, s, r = this.animations;
                for (e.chart = t, e.startTime = Date.now(), e.duration = i, n || (t.animating = !0), o = 0, s = r.length; o < s; ++o)
            ...
            advance: function () {
                for (var t, e, i, n, o = this.animations, s = 0; s < o.length;) e = (t = o[s]).chart, i = t.numSteps, n = Math.floor((Date.now() - t.startTime) / t.duration * i) + 1, t.currentStep = Math.min(n, i), ht.callback(t.render, [e, t], e), ht.callback(t.onAnimationProgress, [t], e), t.currentStep >= i ? (ht.callback(t.onAnimationComplete, [t], e), e.animating = !1, o.splice(s, 1)) : ++s
            }
        },
    ...
    function xt(e, t) {
        ...
        if (i) {
            var n = i.listeners,
                o = n.indexOf(t); - 1 !== o && n.splice(o, 1), 0 < n.length || (_t.forEach(function (t) {
                delete e[t]
            }), delete e._chartjs)
        }
    }
    ...
    ht.extend(wt.prototype, {
        ...
        buildOrUpdateElements: function () {
            var o, t, e = this,
                i = e.getDataset(),
                n = i.data || (i.data = []);
            e._data !== n && (e._data && xt(e._data, e), n && Object.isExtensible(n) && (t = e, (o = n)._chartjs ? o._chartjs.listeners.push(t) : (Object.defineProperty(o, "_chartjs", {
                configurable: !0,
                enumerable: !1,
                value: {
                    listeners: [t]
                ...
                Object.defineProperty(o, t, {
                    ...
                    value: function () {
                        var e = Array.prototype.slice.call(arguments),
                            t = n.apply(this, e);
                        return ht.each(o._chartjs.listeners, function (t) {
        ...
        setHoverStyle: function (t) {
            ...
            }, o.backgroundColor = yt([n.hoverBackgroundColor, e.hoverBackgroundColor, s(o.backgroundColor)], void 0, i), o.borderColor = yt([n.hoverBorderColor, e.hoverBorderColor, s(o.borderColor)], void 0, i), o.borderWidth = yt([n.hoverBorderWidth, e.hoverBorderWidth, o.borderWidth], void 0, i)
        },
            ...
            inRange: function (t, e) {
                ...
                if (i) {
                    for (var n = ht.getAngleFromPoint(i, {
                            x: t,
                            y: e
                        }), o = n.angle, s = n.distance, r = i.startAngle, a = i.endAngle; a < r;) a += 2 * Math.PI;
                    for (; a < o;) o -= 2 * Math.PI;
                    for (; o < r;) o += 2 * Math.PI;
                    var l = r <= o && o <= a,
    ...
    var Pt = gt.extend({
            ...
            draw: function (t) {
                var e = this._view,
                    ...
                    l = at.global,
                    c = l.defaultColor;
                e.skip || void 0 !== t && !ht.canvas._isPointInArea(e, t) || (i.strokeStyle = e.borderColor || c, i.lineWidth = Et(e.borderWidth, l.elements.point.borderWidth), i.fillStyle = e.backgroundColor || c, ht.canvas.drawPoint(i, n, s, r, a, o))
            }
        }),
    ...
    function Ot(t) {
        var e, i, n, o, s;
        return o = $t(t) ? (s = t.width / 2, e = t.x - s, i = t.x + s, n = Math.min(t.y, t.base), Math.max(t.y, t.base)) : (s = t.height / 2, e = Math.min(t.x, t.base), i = Math.max(t.x, t.base), n = t.y - s, t.y + s), {
            left: e,
            top: n,
            right: i,
            bottom: o
    ...
    function Ft(t, e, i) {
        var n = null === e,
            o = null === i,
            s = !(!t || n && o) && Ot(t);
        return s && (n || e >= s.left && e <= s.right) && (o || i >= s.top && i <= s.bottom)
    }
    at._set("global", {
        elements: {
            rectangle: {
    ...
    var zt = gt.extend({
            draw: function () {
                var t, e, i, n, o, s, r, a, l, c, h, d, u, f, p, g, m, v = this._chart.ctx,
                    b = this._view,
                    y = (f = Ot(t = b), p = f.right - f.left, g = f.bottom - f.top, i = p / 2, n = g / 2, d = (e = t).borderWidth, c = (l = e).borderSkipped, h = {}, c && (l.horizontal ? l.base > l.x && (c = Lt(c, "left", "right")) : l.base < l.y && (c = Lt(c, "bottom", "top")), h[c] = !0), u = h, ht.isObject(d) ? (o = +d.top || 0, s = +d.right || 0, r = +d.bottom || 0, a = +d.left || 0) : o = s = r = a = +d || 0, m = {
                    ...
                    _ = y.outer,
                    x = y.inner;
                v.fillStyle = b.backgroundColor, v.fillRect(_.x, _.y, _.w, _.h), _.w === x.w && _.h === x.h || (v.save(), v.beginPath(), v.rect(_.x, _.y, _.w, _.h), v.clip(), v.fillStyle = b.borderColor, v.rect(x.x, x.y, x.w, x.h), v.fill("evenodd"), v.restore())
            },
            height: function () {
                var t = this._view;
                return t.base - t.y
            ...
            getCenterPoint: function () {
                ...
                return e = $t(i) ? (t = i.x, (i.y + i.base) / 2) : (t = (i.x + i.base) / 2, i.y), {
                    x: t,
                    y: e
                }
            },
            getArea: function () {
                var t = this._view;
                return $t(t) ? t.width * Math.abs(t.y - t.base) : t.height * Math.abs(t.x - t.base)
            },
            tooltipPosition: function () {
                var t = this._view;
                return {
    ...
    var qt = St.extend({
            ...
            initialize: function () {
                var t;
                St.prototype.initialize.apply(this, arguments), (t = this.getMeta()).stack = this.getDataset().stack, t.bar = !0
            },
            update: function (t) {
            ...
            _updateElementGeometry: function (t, e, i) {
                ...
                o.horizontal = a, o.base = i ? r : c.base, o.x = a ? i ? r : c.head : h.center, o.y = a ? h.center : i ? r : c.head, o.height = a ? h.size : void 0, o.width = a ? void 0 : h.size
            },
            _getStacks: function (t) {
                var e, i, n = this.chart,
                    ...
                    r = [];
                for (e = 0; e < s; ++e)(i = n.getDatasetMeta(e)).bar && n.isDatasetVisible(e) && (!1 === o || !0 === o && -1 === r.indexOf(i.stack) || void 0 === o && (void 0 === i.stack || -1 === r.indexOf(i.stack))) && r.push(i.stack);
                return r
            },
            ...
            getRuler: function () {
                var t, e, i = this._getIndexScale(),
                    ...
                    l = [];
                for (t = 0, e = this.getMeta().data.length; t < e; ++t) l.push(i.getPixelForValue(null, t, o));
                return {
                    min: ht.isNullOrUndef(i.options.barThickness) ? function (t, e) {
                        var i, n, o, s, r = t.isHorizontal() ? t.width : t.height,
                            a = t.getTicks();
                        for (o = 1, s = e.length; o < s; ++o) r = Math.min(r, Math.abs(e[o] - e[o - 1]));
                        for (o = 0, s = a.length; o < s; ++o) n = t.getPixelForTick(o), r = 0 < o ? Math.min(r, n - i) : r, i = n;
                        return r
                    }(i, l) : -1,
                    pixels: l,
                    start: r,
            ...
            calculateBarValuePixels: function (t, e) {
                ...
                if (g || void 0 === g && void 0 !== m)
                    for (i = 0; i < t; ++i)(n = l.getDatasetMeta(i)).bar && n.stack === m && n.controller._getValueScaleId() === h.id && l.isDatasetVisible(i) && (o = +h.getRightValue(u[i].data[e]), (f < 0 && o < 0 || 0 <= f && 0 < o) && (v += o));
                return s = h.getPixelForValue(v), a = (r = h.getPixelForValue(v + f)) - s, void 0 !== p && Math.abs(a) < p && (a = p, r = 0 <= f && !d || f < 0 && d ? s - p : s + p), {
                    size: a,
                    base: s,
                    head: r,
                    center: r + a / 2
            ...
            calculateBarIndexPixels: function (t, e, i) {
                var n, o, s, r, a, l, c, h, d, u, f, p, g, m, v, b, y = i.scale.options,
                    _ = "flex" === y.barThickness ? (u = y, p = (d = i).pixels, g = p[e], m = 0 < e ? p[e - 1] : null, v = e < p.length - 1 ? p[e + 1] : null, b = u.categoryPercentage, null === m && (m = g - (null === v ? d.end - d.start : v - g)), null === v && (v = g + g - m), f = g - (g - Math.min(m, v)) / 2 * b, {
                        chunk: Math.abs(v - m) / 2 * b / d.stackCount,
                        ratio: u.barPercentage,
                        start: f
                    }) : (n = e, o = i, l = (s = y).barThickness, c = o.stackCount, h = o.pixels[n], a = ht.isNullOrUndef(l) ? (r = o.min * s.categoryPercentage, s.barPercentage) : (r = l * c, 1), {
                        chunk: r / c,
                        ratio: a,
                        start: h - r / 2
                    }),
                    ...
                    S = Math.min(ht.valueOrDefault(y.maxBarThickness, 1 / 0), _.chunk * _.ratio);
                return {
                    base: w - S / 2,
                    head: w + S / 2,
                    center: w,
            ...
            draw: function () {
                var t = this.chart,
                    ...
                    o = i.length,
                    s = 0;
                for (ht.canvas.clipArea(t.ctx, t.chartArea); s < o; ++s) isNaN(e.getRightValue(n.data[s])) || i[s].draw();
            ...
            _resolveElementOptions: function (t, e) {
                ...
                for (i = 0, n = d.length; i < n; ++i) c[o = d[i]] = Bt([a[o], r[o], l[o]], h, e);
                return c
            }
        }),
    ...
    var Yt = St.extend({
            ...
            updateElement: function (t, e, i) {
                var n = this,
                    ...
                    h = n.index,
                    d = i ? r.getPixelForDecimal(.5) : r.getPixelForValue("object" == typeof c ? c : NaN, e, h),
                    u = i ? a.getBasePixel() : a.getPixelForValue(c, e, h);
                t._xScale = r, t._yScale = a, t._options = l, t._datasetIndex = h, t._index = e, t._model = {
            ...
            setHoverStyle: function (t) {
                ...
                t.$previousStyle = {
                    ...
                    radius: e.radius
                }, e.backgroundColor = Vt(i.hoverBackgroundColor, n(i.backgroundColor)), e.borderColor = Vt(i.hoverBorderColor, n(i.borderColor)), e.borderWidth = Vt(i.hoverBorderWidth, i.borderWidth), e.radius = i.radius + i.hoverRadius
            },
            _resolveElementOptions: function (t, e) {
                var i, n, o, s = this.chart,
                    r = s.data.datasets[this.index],
                ...
                for (i = 0, n = u.length; i < n; ++i) h[o = u[i]] = Ut([a[o], r[o], l[o]], d, e);
                return h.radius = Ut([a.radius, c ? c.r : void 0, r.radius, l.radius], d, e), h
            }
        }),
    ...
    at._set("doughnut", {
        ...
        legendCallback: function (t) {
            ...
            var i = t.data,
                ...
                o = i.labels;
            if (n.length)
                for (var s = 0; s < n[0].data.length; ++s) e.push('<li><span style="background-color:' + n[0].backgroundColor[s] + '"></span>'), o[s] && e.push(o[s]), e.push("</li>");
        ...
        legend: {
            labels: {
                generateLabels: function (a) {
                    ...
                    return l.labels.length && l.datasets.length ? l.labels.map(function (t, e) {
                        ...
                        return {
                            text: t,
                            fillStyle: Xt([s.backgroundColor, n.backgroundColor, r.backgroundColor], void 0, e),
                            strokeStyle: Xt([s.borderColor, n.borderColor, r.borderColor], void 0, e),
                            lineWidth: Xt([s.borderWidth, n.borderWidth, r.borderWidth], void 0, e),
            ...
            onClick: function (t, e) {
                var i, n, o, s = e.index,
                    r = this.chart;
                for (i = 0, n = (r.data.datasets || []).length; i < n; ++i)(o = r.getDatasetMeta(i)).data[s] && (o.data[s].hidden = !o.data[s].hidden);
                r.update()
            }
        },
        cutoutPercentage: 50,
    ...
    var Kt = St.extend({
        ...
        update: function (t) {
            ...
            if (p < 2 * Math.PI) {
                var m = r.rotation % (2 * Math.PI),
                    ...
                    S = m <= .5 * Math.PI && .5 * Math.PI <= v || m <= 2.5 * Math.PI && 2.5 * Math.PI <= v,
                    k = m <= -Math.PI && -Math.PI <= v || m <= Math.PI && Math.PI <= v,
                    T = m <= .5 * -Math.PI && .5 * -Math.PI <= v || m <= 1.5 * Math.PI && 1.5 * Math.PI <= v,
                    C = f / 100,
                    ...
                    P = .5 * (M - I),
                    D = .5 * (A - E);
                c = Math.min(a / P, l / D), h = {
                    x: -.5 * (M + I),
                    y: -.5 * (A + E)
                }
            }
            for (e = 0, i = u.length; e < i; ++e) u[e]._options = n._resolveElementOptions(u[e], e);
            for (o.borderWidth = n.getMaxBorderWidth(), o.outerRadius = Math.max((c - o.borderWidth) / 2, 0), o.innerRadius = Math.max(f ? o.outerRadius / 100 * f : 0, 0), o.radiusLength = (o.outerRadius - o.innerRadius) / (n._getVisibleDatasetWeightTotal() || 1), o.offsetX = h.x * o.outerRadius, o.offsetY = h.y * o.outerRadius, d.total = n.calculateTotal(), n.outerRadius = o.outerRadius - o.radiusLength * n._getRingWeightOffset(n.index), n.innerRadius = Math.max(n.outerRadius - o.radiusLength * g, 0), e = 0, i = u.length; e < i; ++e) n.updateElement(u[e], e, t)
        },
        updateElement: function (t, e, i) {
            var n = this,
                o = n.chart,
                ...
                d = r.rotation,
                u = n.getDataset(),
                f = i && a.animateRotate || t.hidden ? 0 : n.calculateCircumference(u.data[e]) * (r.circumference / (2 * Math.PI)),
            ...
            var v = t._model;
            i && a.animateRotate || (v.startAngle = 0 === e ? r.rotation : n.getMeta().data[e - 1]._model.endAngle, v.endAngle = v.startAngle + v.circumference), t.pivot()
        },
        ...
        getMaxBorderWidth: function (t) {
            var e, i, n, o, s, r, a, l, c = 0,
                h = this.chart;
            if (!t)
                for (e = 0, i = h.data.datasets.length; e < i; ++e)
                    if (h.isDatasetVisible(e)) {
                        t = (n = h.getDatasetMeta(e)).data, e !== this.index && (s = n.controller);
                        break
                    } if (!t) return 0;
            for (e = 0, i = t.length; e < i; ++e) o = t[e], "inner" !== (r = s ? s._resolveElementOptions(o, e) : o._options).borderAlign && (a = r.borderWidth, c = (l = r.hoverBorderWidth) > (c = c < a ? a : c) ? l : c);
            return c
        },
        setHoverStyle: function (t) {
            var e = t._model,
            ...
            t.$previousStyle = {
                ...
                borderColor: e.borderColor,
                borderWidth: e.borderWidth
            }, e.backgroundColor = Qt(i.hoverBackgroundColor, n(i.backgroundColor)), e.borderColor = Qt(i.hoverBorderColor, n(i.borderColor)), e.borderWidth = Qt(i.hoverBorderWidth, i.borderWidth)
        },
        _resolveElementOptions: function (t, e) {
            var i, n, o, s = this.chart,
                r = this.getDataset(),
            ...
            for (i = 0, n = d.length; i < n; ++i) c[o = d[i]] = Xt([a[o], r[o], l[o]], h, e);
            return c
        },
    ...
    var ie = St.extend({
            ...
            update: function (t) {
                ...
                for (c && (void 0 !== l.tension && void 0 === l.lineTension && (l.lineTension = l.tension), s._scale = a, s._datasetIndex = n.index, s._children = r, s._model = n._resolveLineOptions(s), s.pivot()), e = 0, i = r.length; e < i; ++e) n.updateElement(r[e], e, t);
                for (c && 0 !== s._model.tension && n.updateBezierControlPoints(), e = 0, i = r.length; e < i; ++e) r[e].pivot()
            },
            updateElement: function (t, e, i) {
                var n, o, s = this,
                    r = s.getMeta(),
                ...
                n = u.getPixelForValue("object" == typeof h ? h : NaN, e, c), o = i ? d.getBasePixel() : s.calculatePointY(h, e, c), t._xScale = u, t._yScale = d, t._options = p, t._datasetIndex = c, t._index = e, t._model = {
                    x: n,
                    y: o,
            ...
            _resolvePointOptions: function (t, e) {
                var i, n, o, s = this.chart,
                    ...
                    u = Object.keys(d);
                for (i = 0, n = u.length; i < n; ++i) c[o = u[i]] = Jt([a[o], r[d[o]], r[o], l[o]], h, e);
                return c
            },
            _resolveLineOptions: function (t) {
                var e, i, n, o = this.chart,
                    s = o.data.datasets[this.index],
                    r = t.custom || {},
                    a = o.options,
                    l = a.elements.line,
                    c = {},
                    h = ["backgroundColor", "borderWidth", "borderColor", "borderCapStyle", "borderDash", "borderDashOffset", "borderJoinStyle", "fill", "cubicInterpolationMode"];
                for (e = 0, i = h.length; e < i; ++e) c[n = h[e]] = Jt([r[n], s[n], l[n]]);
                return c.spanGaps = Zt(s.spanGaps, a.spanGaps), c.tension = Zt(s.lineTension, l.tension), c.steppedLine = Jt([r.steppedLine, s.steppedLine, l.stepped]), c
            },
            calculatePointY: function (t, e, i) {
                var n, o, s, r = this.chart,
                    a = this.getMeta(),
                ...
                if (l.options.stacked) {
                    for (n = 0; n < i; n++)
                        if (o = r.data.datasets[n], "line" === (s = r.getDatasetMeta(n)).type && s.yAxisID === l.id && r.isDatasetVisible(n)) {
                            var d = Number(l.getRightValue(o.data[e]));
                            d < 0 ? h += d || 0 : c += d || 0
                        } var u = Number(l.getRightValue(t));
                    return u < 0 ? l.getPixelForValue(h + u) : l.getPixelForValue(c + u)
                }
            ...
            updateBezierControlPoints: function () {
                ...
                if (r.spanGaps && (l = l.filter(function (t) {
                    ...
                    })), "monotone" === r.cubicInterpolationMode) ht.splineCurveMonotone(l);
                else
                    for (t = 0, e = l.length; t < e; ++t) i = l[t]._model, n = ht.splineCurve(ht.previousItem(l, t)._model, i, ht.nextItem(l, t)._model, r.tension), i.controlPointPreviousX = n.previous.x, i.controlPointPreviousY = n.previous.y, i.controlPointNextX = n.next.x, i.controlPointNextY = n.next.y;
                if (o.options.elements.line.capBezierPoints)
                    for (t = 0, e = l.length; t < e; ++t) i = l[t]._model, te(i, a) && (0 < t && te(l[t - 1]._model, a) && (i.controlPointPreviousX = c(i.controlPointPreviousX, a.left, a.right), i.controlPointPreviousY = c(i.controlPointPreviousY, a.top, a.bottom)), t < l.length - 1 && te(l[t + 1]._model, a) && (i.controlPointNextX = c(i.controlPointNextX, a.left, a.right), i.controlPointNextY = c(i.controlPointNextY, a.top, a.bottom)))
            },
            draw: function () {
                var t, e = this.chart,
                    i = this.getMeta(),
                ...
                for (ee(this.getDataset(), e.options) && (t = (i.dataset._model.borderWidth || 0) / 2, ht.canvas.clipArea(e.ctx, {
                        ...
                        top: o.top - t,
                        bottom: o.bottom + t
                    }), i.dataset.draw(), ht.canvas.unclipArea(e.ctx)); r < s; ++r) n[r].draw(o)
            },
            setHoverStyle: function (t) {
                var e = t._model,
                    i = t._options,
        ...
        legend: {
            labels: {
                generateLabels: function (r) {
                    var a = r.data;
                    return a.labels.length && a.datasets.length ? a.labels.map(function (t, e) {
                        ...
                        return {
                            text: t,
                            fillStyle: ne([o.backgroundColor, n.backgroundColor, s.backgroundColor], void 0, e),
                            strokeStyle: ne([o.borderColor, n.borderColor, s.borderColor], void 0, e),
                            lineWidth: ne([o.borderWidth, n.borderWidth, s.borderWidth], void 0, e),
                            hidden: isNaN(n.data[e]) || i.data[e].hidden,
                            index: e
                        }
                    }) : []
            ...
            onClick: function (t, e) {
                var i, n, o, s = e.index,
                    r = this.chart;
                for (i = 0, n = (r.data.datasets || []).length; i < n; ++i)(o = r.getDatasetMeta(i)).data[s].hidden = !o.data[s].hidden;
                r.update()
            }
        },
        tooltips: {
    ...
    var oe = St.extend({
        ...
        update: function (t) {
            var e, i, n, o = this,
                ...
                c = o._angles = [],
                h = r.data;
            for (o._updateRadius(), r.count = o.countVisibleElements(), e = 0, i = s.data.length; e < i; e++) l[e] = a, n = o._computeAngle(e), a += c[e] = n;
            for (e = 0, i = h.length; e < i; ++e) h[e]._options = o._resolveElementOptions(h[e], e), o.updateElement(h[e], e, t)
        },
        _updateRadius: function () {
            ...
            e.outerRadius = Math.max(o / 2, 0), e.innerRadius = Math.max(n.cutoutPercentage ? e.outerRadius / 100 * n.cutoutPercentage : 1, 0), e.radiusLength = (e.outerRadius - e.innerRadius) / e.getVisibleDatasetCount(), t.outerRadius = e.outerRadius - e.radiusLength * t.index, t.innerRadius = t.outerRadius - e.radiusLength
        },
        updateElement: function (t, e, i) {
            var n = this,
                o = n.chart,
        ...
        setHoverStyle: function (t) {
            ...
            t.$previousStyle = {
                ...
                borderColor: e.borderColor,
                borderWidth: e.borderWidth
            }, e.backgroundColor = o(i.hoverBackgroundColor, n(i.backgroundColor)), e.borderColor = o(i.hoverBorderColor, n(i.borderColor)), e.borderWidth = o(i.hoverBorderWidth, i.borderWidth)
        },
        _resolveElementOptions: function (t, e) {
            var i, n, o, s = this.chart,
                r = this.getDataset(),
                ...
                d = ["backgroundColor", "borderColor", "borderWidth", "borderAlign", "hoverBackgroundColor", "hoverBorderColor", "hoverBorderWidth"];
            for (i = 0, n = d.length; i < n; ++i) c[o = d[i]] = ne([a[o], r[o], l[o]], h, e);
            return c
        },
        _computeAngle: function (t) {
            ...
            return ne([e.chart.options.elements.arc.angle, 2 * Math.PI / i], s, t)
        }
    });
    at._set("pie", ht.clone(at.doughnut)), at._set("pie", {
        cutoutPercentage: 0
    });
    var se = Kt,
    ...
    var le = St.extend({
        ...
        update: function (t) {
            var e, i, n = this,
                ...
                a = n.chart.scale,
                l = n.getDataset();
            for (void 0 !== l.tension && void 0 === l.lineTension && (l.lineTension = l.tension), s._scale = a, s._datasetIndex = n.index, s._children = r, s._loop = !0, s._model = n._resolveLineOptions(s), s.pivot(), e = 0, i = r.length; e < i; ++e) n.updateElement(r[e], e, t);
        ...
        _resolvePointOptions: function (t, e) {
            var i, n, o, s = this.chart,
                ...
                u = Object.keys(d);
            for (i = 0, n = u.length; i < n; ++i) c[o = u[i]] = ae([a[o], r[d[o]], r[o], l[o]], h, e);
            return c
        },
        _resolveLineOptions: function (t) {
            var e, i, n, o = this.chart,
            ...
            for (e = 0, i = c.length; e < i; ++e) l[n = c[e]] = ae([r[n], s[n], a[n]]);
    ...
    function ge(n, t, e) {
        ...
        var o = pe(e.axis),
            ...
            r = [];
        return s.length ? (n.data.datasets.forEach(function (t, e) {
    ...
    var _e, xe = {
            ...
            configure: function (t, e, i) {
                for (var n, o = ["fullWidth", "position", "weight"], s = o.length, r = 0; r < s; ++r) n = o[r], i.hasOwnProperty(n) && (e[n] = i[n])
            },
            update: function (e, i, t) {
                if (e) {
                    ...
                    ht.each(v, function (t) {
                        ...
                        i ? (e = t.update(t.fullWidth ? b : x, y / 2), w -= e.height) : (e = t.update(_, w), x -= e.width), k.push({
                            horizontal: i,
                            width: e.width,
                            box: t
                        })
                    }), P = v, L = O = $ = D = 0, ht.each(P, function (t) {
                        if (t.getPadding) {
                            var e = t.getPadding();
                            D = Math.max(D, e.top), $ = Math.max($, e.left), O = Math.max(O, e.bottom), L = Math.max(L, e.right)
                        }
                    }), p = {
                        top: D,
                        left: $,
                        bottom: O,
                        right: L
                    }, ht.each(g, F), ye(g, S), ht.each(m, F), ye(m, S), ht.each(g, function (e) {
                    ...
                    var M = s + T,
                        A = a + C;
                    ht.each(c.concat(d), z), M += x, A += w, ht.each(h, z), ht.each(u, z), e.chartArea = {
                        left: S.left,
                        top: S.top,
                        right: S.left + x,
                        bottom: S.top + w
                ...
                function z(t) {
                    t.isHorizontal() ? (t.left = t.fullWidth ? s : S.left, t.right = t.fullWidth ? i - r : S.left + x, t.top = A, t.bottom = A + t.height, A = t.bottom) : (t.left = M, t.right = M + t.width, t.top = S.top, t.bottom = S.top + w, M = t.right)
                }
            }
        },
        we = (_e = Object.freeze({
    ...
    function Oe(i, n, o) {
        var t, e, s, r, a, l, c, h = i[Se] || (i[Se] = {}),
            d = h.resizer = function (t) {
                var e = $e(ke),
                    i = $e(ke + "-expand"),
                    n = $e(ke + "-shrink");
                i.appendChild($e()), n.appendChild($e()), e.appendChild(i), e.appendChild(n), e._reset = function () {
                ...
                return Ae(i, "scroll", o.bind(i, "expand")), Ae(n, "scroll", o.bind(n, "shrink")), e
            }((s = !(t = function () {
                if (h.resizer) {
                    var t = o.options.maintainAspectRatio && i.parentNode,
                        e = t ? t.clientWidth : 0;
                    n(De("resize", o)), t && t.clientWidth < e && o.canvas && n(De("resize", o))
                }
            }), r = [], function () {
                r = Array.prototype.slice.call(arguments), e = e || this, s || (s = !0, ht.requestAnimFrame.call(window, function () {
                    s = !1, t.apply(e, r)
                }))
            }));
        l = (a = i)[Se] || (a[Se] = {}), c = l.renderProxy = function (t) {
            ...
            Ae(a, t, c)
        }), l.reflow = !!a.offsetParent, a.classList.add(Te)
    }
    var Le = {
        ...
        addEventListener: function (s, t, r) {
            ...
            if ("resize" !== t) {
                var i = r[Se] || (r[Se] = {});
                Ae(e, t, (i.proxies || (i.proxies = {}))[s.id + "_" + t] = function (t) {
                    var e, i, n, o;
                    r((i = s, n = Ie[(e = t).type] || e.type, o = ht.getRelativePosition(e, i), De(n, i, o.x, o.y, e)))
                })
            } else Oe(e, r, s)
        },
        removeEventListener: function (t, e, i) {
            var n, o, s, r, a, l, c = t.canvas;
            if ("resize" !== e) {
                var h = ((i[Se] || {}).proxies || {})[t.id + "_" + e];
                h && Pe(c, e, h)
            } else a = (n = c)[Se] || {}, l = a.resizer, delete a.resizer, s = (o = n)[Se] || {}, (r = s.renderProxy) && (ht.each(Ce, function (t) {
                Pe(o, t, r)
            }), delete s.renderProxy), o.classList.remove(Te), l && l.parentNode && l.parentNode.removeChild(l)
        }
    };
    ht.addEvent = Ae, ht.removeEvent = Pe;
    var Fe = Le._enabled ? Le : {
    ...
    var Re = {
            ...
            notify: function (t, e, i) {
                var n, o, s, r, a, l = this.descriptors(t),
                    c = l.length;
                for (n = 0; n < c; ++n)
                    if ("function" == typeof (a = (s = (o = l[n]).plugin)[e]) && ((r = [t].concat(i || [])).push(o.options), !1 === a.apply(s, r))) return !1;
                return !0
            },
            descriptors: function (t) {
                ...
                return this._plugins.concat(i.plugins || []).forEach(function (t) {
                    if (-1 === n.indexOf(t)) {
                        var e = t.id,
                            i = s[e];
                        !1 !== i && (!0 === i && (i = ht.clone(at.global.plugins[e])), n.push(t), o.push({
                            plugin: t,
                            options: i || {}
                        }))
                    }
        ...
        Ne = {
            ...
            getScaleDefaults: function (t) {
                return this.defaults.hasOwnProperty(t) ? ht.merge({}, [at.scale, this.defaults[t]]) : {}
            },
            ...
            addScalesToLayout: function (e) {
                ht.each(e.scales, function (t) {
                    t.fullWidth = t.options.fullWidth, t.position = t.options.position, t.weight = t.options.weight, xe.addBox(e, t)
                })
            }
        },
        ...
        tooltips: {
            ...
            callbacks: {
                ...
                title: function (t, e) {
                    ...
                    if (0 < t.length) {
                        var s = t[0];
                        s.label ? i = s.label : s.xLabel ? i = s.xLabel : 0 < o && s.index < o && (i = n[s.index])
                    }
                    return i
                },
                afterTitle: ht.noop,
    ...
    var Ye = gt.extend({
            ...
            getBody: function (t, i) {
                ...
                return ht.each(t, function (t) {
                    ...
                    We(e.before, Be(o.beforeLabel.call(n, t, i))), We(e.lines, o.label.call(n, t, i)), We(e.after, Be(o.afterLabel.call(n, t, i))), s.push(e)
                }), s
            },
            ...
            update: function (t) {
                var e, i, n, o, s, r, a, l, c, h, d, u, f, p, g, m, v, b, y, _, x, w, S, k = this,
                    T = k._options,
                    C = k._model,
                    I = k._model = qe(T),
                    E = k._active,
                ...
                if (E.length) {
                    ...
                    var F = [];
                    for (e = 0, i = E.length; e < i; ++e) F.push((h = c = l = s = o = void 0, o = (n = E[e])._xScale, s = n._yScale || n._scale, r = n._index, a = n._datasetIndex, c = (l = n._chart.getDatasetMeta(a).controller)._getIndexScale(), h = l._getValueScale(), {
                    ...
                    T.filter && (F = F.filter(function (t) {
                        return T.filter(t, M)
                    })), T.itemSort && (F = F.sort(function (t, e) {
                        return T.itemSort(t, e, M)
                    })), ht.each(F, function (t) {
                        O.push(T.callbacks.labelColor.call(k, t, k._chart)), L.push(T.callbacks.labelTextColor.call(k, t, k._chart))
                    }), I.title = k.getTitle(F, M), I.beforeBody = k.getBeforeBody(F, M), I.body = k.getBody(F, M), I.afterBody = k.getAfterBody(F, M), I.footer = k.getFooter(F, M), I.x = $.x, I.y = $.y, I.caretPadding = T.caretPadding, I.labelColors = O, I.labelTextColors = L, I.dataPoints = F, D = function (t, e) {
                        var i = t._chart.ctx,
                            n = 2 * e.yPadding,
                            o = 0,
                            s = e.body,
                        ...
                        var a = e.title.length,
                            ...
                            h = e.bodyFontSize,
                            d = e.footerFontSize;
                        n += a * c, n += a ? (a - 1) * e.titleSpacing : 0, n += a ? e.titleMarginBottom : 0, n += r * h, n += r ? (r - 1) * e.bodySpacing : 0, n += l ? e.footerMarginTop : 0, n += l * d, n += l ? (l - 1) * e.footerSpacing : 0;

                        function u(t) {
                            o = Math.max(o, i.measureText(t).width + f)
                        }
                        var f = 0;
                        return i.font = ht.fontString(c, e._titleFontStyle, e._titleFontFamily), ht.each(e.title, u), i.font = ht.fontString(h, e._bodyFontStyle, e._bodyFontFamily), ht.each(e.beforeBody.concat(e.afterBody), u), f = e.displayColors ? h + 2 : 0, ht.each(s, function (t) {
                            ht.each(t.before, u), ht.each(t.lines, u), ht.each(t.after, u)
                        }), f = 0, i.font = ht.fontString(d, e._footerFontStyle, e._footerFontFamily), ht.each(e.footer, u), {
                            width: o += 2 * e.xPadding,
                            height: n
                        }
                    }(this, I), d = I, f = A = function (t, e) {
                        var i, n, o, s, r, a = t._model,
                            l = t._chart,
                            c = t._chart.chartArea,
                            h = "center",
                            d = "center";
                        a.y < e.height ? d = "top" : a.y > l.height - e.height && (d = "bottom");
                        ...
                        }, i(a.x) ? (h = "left", o(a.x) && (h = "center", d = r(a.y))) : n(a.x) && (h = "right", s(a.x) && (h = "center", d = r(a.y)));
                        var p = t._options;
                        return {
                            xAlign: p.xAlign ? p.xAlign : h,
                            yAlign: p.yAlign ? p.yAlign : d
                        }
                    }(this, u = D), p = k._chart, g = d.x, m = d.y, v = d.caretSize, b = d.caretPadding, y = d.cornerRadius, _ = f.xAlign, x = f.yAlign, w = v + b, S = y + b, "right" === _ ? g -= u.width : "center" === _ && ((g -= u.width / 2) + u.width > p.width && (g = p.width - u.width), g < 0 && (g = 0)), "top" === x ? m += w : m -= "bottom" === x ? u.height + w : u.height / 2, "center" === x ? "left" === _ ? g += w : "right" === _ && (g -= w) : "left" === _ ? g -= S : "right" === _ && (g += S), P = {
                        x: g,
                        y: m
                    }
                } else I.opacity = 0;
                return I.xAlign = A.xAlign, I.yAlign = A.yAlign, I.x = P.x, I.y = P.y, I.width = D.width, I.height = D.height, I.caretX = $.x, I.caretY = $.y, k._model = I, t && T.custom && T.custom.call(k, I), k
            },
            ...
            getCaretPosition: function (t, e, i) {
                var n, o, s, r, a, l, c = i.caretSize,
                    ...
                    g = e.width,
                    m = e.height;
                if ("center" === u) a = p + m / 2, l = "left" === d ? (o = (n = f) - c, s = n, r = a + c, a - c) : (o = (n = f + g) + c, s = n, r = a - c, a + c);
                else if (s = (n = "left" === d ? (o = f + h + c) - c : "right" === d ? (o = f + g - h - c) - c : (o = i.caretX) - c, o + c), "top" === u) a = (r = p) - c, l = r;
                else {
                    a = (r = p + m) + c, l = r;
                    var v = s;
                    s = n, n = v
            ...
            drawTitle: function (t, e, i) {
                ...
                if (n.length) {
                    ...
                    var o, s, r = e.titleFontSize,
                        a = e.titleSpacing;
                    for (i.fillStyle = e.titleFontColor, i.font = ht.fontString(r, e._titleFontStyle, e._titleFontFamily), o = 0, s = n.length; o < s; ++o) i.fillText(n[o], t.x, t.y), t.y += r + a, o + 1 === n.length && (t.y += e.titleMarginBottom - a)
                }
            },
            drawBody: function (i, n, o) {
                var s, r = n.bodyFontSize,
                    e = n.bodySpacing,
                    t = n._bodyAlign,
                    a = n.body,
                    l = n.displayColors,
                    ...
                    h = 0,
                    d = l ? Ve(n, "left") : 0;
                o.textAlign = t, o.textBaseline = "top", o.font = ht.fontString(r, n._bodyFontStyle, n._bodyFontFamily), i.x = Ve(n, t);

                function u(t) {
                    o.fillText(t, i.x + h, i.y), i.y += r + e
                }
                o.fillStyle = n.bodyFontColor, ht.each(n.beforeBody, u), h = l && "right" !== t ? "center" === t ? r / 2 + 1 : r + 2 : 0, ht.each(a, function (t, e) {
                    s = n.labelTextColors[e], o.fillStyle = s, ht.each(t.before, u), ht.each(t.lines, function (t) {
                        l && (o.fillStyle = n.legendColorBackground, o.fillRect(d, i.y, r, r), o.lineWidth = 1, o.strokeStyle = c[e].borderColor, o.strokeRect(d, i.y, r, r), o.fillStyle = c[e].backgroundColor, o.fillRect(d + 1, i.y + 1, r - 2, r - 2), o.fillStyle = s), u(t)
                    }), ht.each(t.after, u)
                }), h = 0, ht.each(n.afterBody, u), i.y -= e
            },
            drawFooter: function (e, i, n) {
                var t = i.footer;
                t.length && (e.x = Ve(i, i._footerAlign), e.y += i.footerMarginTop, n.textAlign = i._footerAlign, n.textBaseline = "top", n.fillStyle = i.footerFontColor, n.font = ht.fontString(i.footerFontSize, i._footerFontStyle, i._footerFontFamily), ht.each(t, function (t) {
            ...
            draw: function () {
                ...
                if (0 !== e.opacity) {
                    ...
                    this._options.enabled && s && (t.save(), t.globalAlpha = o, this.drawBackground(n, e, t, i), n.y += e.yPadding, this.drawTitle(n, e, t), this.drawBody(n, e, t), this.drawFooter(n, e, t), t.restore())
                }
            },
    ...
    function Ge() {
        return ht.merge({}, [].slice.call(arguments), {
            merger: function (t, e, i, n) {
                if ("xAxes" === t || "yAxes" === t) {
                    var o, s, r, a = i[t].length;
                    for (e[t] || (e[t] = []), o = 0; o < a; ++o) r = i[t][o], s = Ke(r.type, "xAxes" === t ? "category" : "linear"), o >= e[t].length && e[t].push({}), !e[t][o].type || r.type && r.type !== e[t][o].type ? ht.merge(e[t][o], [Ne.getScaleDefaults(s), r]) : ht.merge(e[t][o], r)
    ...
    function Ze() {
        return ht.merge({}, [].slice.call(arguments), {
            merger: function (t, e, i, n) {
                var o = e[t] || {},
                    s = i[t];
                "scales" === t ? e[t] = Ge(o, s) : "scale" === t ? e[t] = ht.merge(o, [Ne.getScaleDefaults(s.type), s]) : ht._merger(t, e, i, n)
            }
        })
    }
    ...
    ht.extend(ti.prototype, {
        construct: function (t, e) {
            var i, n, o = this;
            (n = (i = (i = e) || {}).data = i.data || {}).datasets = n.datasets || [], n.labels = n.labels || [], i.options = Ze(at.global, at[i.type], i.options || {}), e = i;
            var s = ze.acquireContext(t, e),
                r = s && s.canvas,
                a = r && r.height,
                l = r && r.width;
            o.id = ht.uid(), o.ctx = s, o.canvas = r, o.config = e, o.width = l, o.height = a, o.aspectRatio = a ? l / a : null, o.options = e.options, o._bufferedRender = !1, (o.chart = o).controller = o, ti.instances[o.id] = o, Object.defineProperty(o, "data", {
                get: function () {
            ...
            }), s && r ? (o.initialize(), o.update()) : console.error("Failed to create chart: can't acquire context from the given item")
        },
        initialize: function () {
            var t = this;
            return Re.notify(t, "beforeInit"), ht.retinaScale(t, t.options.devicePixelRatio), t.bindEvents(), t.options.responsive && t.resize(!0), t.ensureScalesHaveIDs(), t.buildOrUpdateScales(), t.initToolTip(), Re.notify(t, "afterInit"), t
        },
        clear: function () {
        ...
        resize: function (t) {
            ...
            if ((e.width !== s || e.height !== r) && (n.width = e.width = s, n.height = e.height = r, n.style.width = s + "px", n.style.height = r + "px", ht.retinaScale(e, i.devicePixelRatio), !t)) {
                var a = {
                    width: s,
                    height: r
                };
                Re.notify(e, "resize", [a]), i.onResize && i.onResize(e, a), e.stop(), e.update({
        ...
        buildOrUpdateScales: function () {
            ...
            t.scales && (e = e.concat((t.scales.xAxes || []).map(function (t) {
                ...
                var o = null;
                if (i in a && a[i].type === n)(o = a[i]).options = e, o.ctx = r.ctx, o.chart = r;
                else {
                ...
                t || delete a[e]
            }), r.scales = a, Ne.addScalesToLayout(this)
        },
        buildOrUpdateControllers: function () {
            var s = this,
                r = [];
            return ht.each(s.data.datasets, function (t, e) {
                var i = s.getDatasetMeta(e),
                    n = t.type || s.config.type;
                if (i.type && i.type !== n && (s.destroyDatasetMeta(e), i = s.getDatasetMeta(e)), i.type = n, i.controller) i.controller.updateIndex(e), i.controller.linkScales();
                else {
                    var o = ce[i.type];
        ...
        update: function (t) {
            ...
            if (t && "object" == typeof t || (t = {
                    ...
                    xe.removeBox(e, t)
                }), i = Ze(at.global, at[e.config.type], i), e.options = e.config.options = i, e.ensureScalesHaveIDs(), e.buildOrUpdateScales(), e.tooltip._options = i.tooltips, e.tooltip.initialize(), Re._invalidate(n), !1 !== Re.notify(n, "beforeUpdate")) {
                n.tooltip._data = n.data;
                var o = n.buildOrUpdateControllers();
                ht.each(n.data.datasets, function (t, e) {
                    n.getDatasetMeta(e).controller.buildOrUpdateElements()
                }, n), n.updateLayout(), n.options.animation && n.options.animation.duration && ht.each(o, function (t) {
                    t.reset()
                }), n.updateDatasets(), n.tooltip.initialize(), n.lastActive = [], Re.notify(n, "afterUpdate"), n._bufferedRender ? n._bufferedRequest = {
                    duration: t.duration,
                    easing: t.easing,
                    lazy: t.lazy
                } : n.render(t)
        ...
        updateLayout: function () {
            !1 !== Re.notify(this, "beforeLayout") && (xe.update(this, this.width, this.height), Re.notify(this, "afterScaleUpdate"), Re.notify(this, "afterLayout"))
        },
        ...
        draw: function (t) {
            var e = this;
            e.clear(), ht.isNullOrUndef(t) && (t = 1), e.transition(t), e.width <= 0 || e.height <= 0 || !1 !== Re.notify(e, "beforeDraw", [t]) && (ht.each(e.boxes, function (t) {
                t.draw(e.chartArea)
        ...
        drawDataset: function (t, e) {
            ...
            !1 !== Re.notify(this, "beforeDatasetDraw", [n]) && (i.controller.draw(e), Re.notify(this, "afterDatasetDraw", [n]))
        },
        ...
        destroy: function () {
            ...
            n && (i.unbindEvents(), ht.canvas.clear(i), ze.releaseContext(i.ctx), i.canvas = null, i.ctx = null), Re.notify(i, "destroy"), delete ti.instances[i.id]
        },
        ...
        bindEvents: function () {
            ...
            ht.each(e.options.events, function (t) {
                ...
                e.resize()
            }, ze.addEventListener(e, "resize", n), i.resize = n)
        },
        ...
        updateHoverStyle: function (t, e, i) {
            var n, o, s, r = i ? "setHoverStyle" : "removeHoverStyle";
            for (o = 0, s = t.length; o < s; ++o)(n = t[o]) && this.getDatasetMeta(n._datasetIndex).controller[r](n)
        },
        eventHandler: function (t) {
            ...
            if (!1 !== Re.notify(e, "beforeEvent", [t])) {
                ...
                i && (n = i._start ? i.handleEvent(t) : n | i.handleEvent(t)), Re.notify(e, "afterEvent", [t]);
        ...
        handleEvent: function (t) {
            var e, i = this,
                n = i.options || {},
                o = n.hover;
            return i.lastActive = i.lastActive || [], "mouseout" === t.type ? i.active = [] : i.active = i.getElementsAtEventForMode(t, o.mode, o), ht.callback(n.onHover || n.hover.onHover, [t.native, i.active], i), "mouseup" !== t.type && "click" !== t.type || n.onClick && n.onClick.call(i, t.native, i.active), i.lastActive.length && i.updateHoverStyle(i.lastActive, o.mode, !1), i.active.length && o.mode && i.updateHoverStyle(i.active, o.mode, !0), e = !ht.arrayEquals(i.active, i.lastActive), i.lastActive = i.active, e
        }
    }), ti.instances = {};
    var ei = ti;
    ...
    function ni(t) {
        this.options = t || {}
    }(ti.Controller = ti).types = {}, ht.configMerge = Ze, ht.scaleMerge = Ge, ht.extend(ni.prototype, {
        formats: ii,
        parse: ii,
        format: ii,
        add: ii,
    ...
    var hi = gt.extend({
            ...
            update: function (t, e, i) {
                ...
                for (c.beforeUpdate(), c.maxWidth = t, c.maxHeight = e, c.margins = ht.extend({
                        left: 0,
                        right: 0,
                        top: 0,
                        bottom: 0
                    }, i), c._maxLabelLines = 0, c.longestLabelWidth = 0, c.longestTextCache = c.longestTextCache || {}, c.beforeSetDimensions(), c.setDimensions(), c.afterSetDimensions(), c.beforeDataLimits(), c.determineDataLimits(), c.afterDataLimits(), c.beforeBuildTicks(), a = c.buildTicks() || [], a = c.afterBuildTicks(a) || a, c.beforeTickToLabelConversion(), s = c.convertTicksToLabels(a) || c.ticks, c.afterTickToLabelConversion(), n = 0, o = (c.ticks = s).length; n < o; ++n) r = s[n], (l = a[n]) ? l.label = r : a.push(l = {
                    label: r,
                    major: !1
                });
                return c._ticks = a, c.beforeCalculateTickRotation(), c.calculateTickRotation(), c.afterCalculateTickRotation(), c.beforeFit(), c.fit(), c.afterFit(), c.afterUpdate(), c.minSize
            },
            ...
            calculateTickRotation: function () {
                ...
                if (n.length && t.options.display && t.isHorizontal())
                    for (var r, a = ht.longestText(e, o.string, n, t.longestTextCache), l = a, c = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; c < l && s < i.maxRotation;) {
            ...
            fit: function () {
                ...
                if (e.width = c ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : a && r.drawTicks ? u : 0, e.height = c ? a && r.drawTicks ? u : 0 : t.maxHeight, s.display && a) {
                    var f = h(s),
                ...
                if (o.display && a) {
                    ...
                    if (t._maxLabelLines = v, t.longestLabelWidth = m, c) {
                        ...
                        e.height = Math.min(t.maxHeight, e.height + w + y), t.ctx.font = d.string;
                        var S, k, T = ci(t.ctx, i[0], d.string),
                            C = ci(t.ctx, i[i.length - 1], d.string),
                            I = t.getPixelForTick(0) - t.left,
                            E = t.right - t.getPixelForTick(i.length - 1);
                        k = 0 !== t.labelRotation ? (S = "bottom" === l ? x * T : x * b, "bottom" === l ? x * b : x * C) : (S = T / 2, C / 2), t.paddingLeft = Math.max(S - I, 0) + 3, t.paddingRight = Math.max(k - E, 0) + 3
                    } else o.mirror ? m = 0 : m += y + b, e.width = Math.min(t.maxWidth, e.width + m), t.paddingTop = d.size / 2, t.paddingBottom = d.size / 2
                }
            ...
            getPixelForTick: function (t) {
                ...
                if (e.isHorizontal()) {
                    var n = (e.width - (e.paddingLeft + e.paddingRight)) / Math.max(e._ticks.length - (i ? 0 : 1), 1),
                        o = n * t + e.paddingLeft;
                    return i && (o += n / 2), e.left + o + (e.isFullWidth() ? e.margins.left : 0)
                }
            ...
            _autoSkip: function (t) {
                var e, i, n = this.isHorizontal(),
                    ...
                    c = n ? this.width - (this.paddingLeft + this.paddingRight) : this.height - (this.paddingTop + this.PaddingBottom),
                    h = [];
                for (c < l && (r = 1 + Math.floor(l / c)), a < s && (r = Math.max(r, 1 + Math.floor(s / a))), e = 0; e < s; e++) i = t[e], 1 < r && 0 < e % r && delete i.label, h.push(i);
                return h
            },
            _tickSize: function () {
                ...
                return t ? r * o < l * n ? r / n : l / o : l * o < r * n ? l / n : r / o
            },
            _isVisible: function () {
            ...
            draw: function (I) {
                ...
                if (E._isVisible()) {
                    var t, A, P, D = E.chart,
                        ...
                        s = a.display && a.autoSkip ? E._autoSkip(E.getTicks()) : E.getTicks(),
                        l = ri(a.fontColor, e),
                        c = o(a),
                        R = c.lineHeight,
                        h = ri(i.fontColor, e),
                        ...
                        V = ht._alignPixel;
                    if (P = "top" === O ? (t = V(D, E.bottom, q), A = E.bottom - j, t - q / 2) : "bottom" === O ? (t = V(D, E.top, q), A = t + q / 2, E.top + j) : "left" === O ? (t = V(D, E.right, q), A = E.right - j, t - q / 2) : (t = V(D, E.left, q), A = t + q / 2, E.left + j), ht.each(s, function (t, e) {
                            if (!ht.isNullOrUndef(t.label)) {
                                var i, n, o, s, r, a, l, c, h, d, u, f, p, g, m, v, b = t.label;
                                s = e === E.zeroLineIndex && M.offset === $.offsetGridLines ? (i = $.zeroLineWidth, n = $.zeroLineColor, o = $.zeroLineBorderDash || [], $.zeroLineBorderDashOffset || 0) : (i = ai($.lineWidth, e), n = ai($.color, e), o = $.borderDash || [], $.borderDashOffset || 0);
                                var y = ht.isArray(b) ? b.length : 1,
                                    _ = (S = E, k = e, T = $.offsetGridLines, C = S.getPixelForTick(k), T && (1 === S.getTicks().length ? C -= S.isHorizontal() ? Math.max(C - S.left, S.right - C) : Math.max(C - S.top, S.bottom - C) : C -= 0 === k ? (S.getPixelForTick(1) - C) / 2 : (C - S.getPixelForTick(k - 1)) / 2), C);
                                if (z) {
                                    var x = j + N;
                                    _ < E.left - 1e-7 && (n = "rgba(0,0,0,0)"), r = l = h = u = V(D, _, i), a = A, c = P, p = E.getPixelForTick(e) + H, g = "top" === O ? (d = V(D, I.top, q) + q / 2, f = I.bottom, m = ((L ? 1 : .5) - y) * R, v = L ? "left" : "center", E.bottom - x) : (d = I.top, f = V(D, I.bottom, q) - q / 2, m = (L ? 0 : .5) * R, v = L ? "right" : "center", E.top + x)
                                } else {
                                    var w = (F ? 0 : j) + N;
                                    _ < E.top - 1e-7 && (n = "rgba(0,0,0,0)"), r = A, l = P, a = c = d = f = V(D, _, i), g = E.getPixelForTick(e) + H, m = (1 - y) * R / 2, p = "left" === O ? (h = V(D, I.left, q) + q / 2, u = I.right, v = F ? "left" : "right", E.right - w) : (h = I.left, u = V(D, I.right, q) - q / 2, v = F ? "right" : "left", E.left + w)
                                }
                                B.push({
                                    tx1: r,
                                    ty1: a,
                            ...
                            var e = t.glWidth,
                                i = t.glColor;
                            if ($.display && e && i && (r.save(), r.lineWidth = e, r.strokeStyle = i, r.setLineDash && (r.setLineDash(t.glBorderDash), r.lineDashOffset = t.glBorderDashOffset), r.beginPath(), $.drawTicks && (r.moveTo(t.tx1, t.ty1), r.lineTo(t.tx2, t.ty2)), $.drawOnChartArea && (r.moveTo(t.x1, t.y1), r.lineTo(t.x2, t.y2)), r.stroke(), r.restore()), a.display) {
                                r.save(), r.translate(t.labelX, t.labelY), r.rotate(t.rotation), r.font = t.major ? d.string : c.string, r.fillStyle = t.major ? h : l, r.textBaseline = "middle", r.textAlign = t.textAlign;
                                var n = t.label,
                                    o = t.textOffset;
                                if (ht.isArray(n))
                                    for (var s = 0; s < n.length; ++s) r.fillText("" + n[s], 0, o), o += R;
                        ...
                        var g, m, v = 0,
                            b = f.lineHeight / 2;
                        if (z) g = E.left + (E.right - E.left) / 2, m = "bottom" === O ? E.bottom - b - p.bottom : E.top + b + p.top;
                        else {
                            var y = "left" === O;
                            g = y ? E.left + b + p.top : E.right - b - p.top, m = E.top + (E.bottom - E.top) / 2, v = y ? -.5 * Math.PI : .5 * Math.PI
                        }
                        r.save(), r.translate(g, m), r.rotate(v), r.textAlign = "center", r.textBaseline = "middle", r.fillStyle = u, r.font = f.string, r.fillText(n.labelString, 0, 0), r.restore()
                    }
                    if (q) {
                        var _, x, w, S, k = q,
                            T = ai($.lineWidth, s.length - 1, 0);
                        z ? (_ = V(D, E.left, k) - k / 2, x = V(D, E.right, T) + T / 2, w = S = t) : (w = V(D, E.top, k) - k / 2, S = V(D, E.bottom, T) + T / 2, _ = x = t), r.lineWidth = q, r.strokeStyle = ai($.color, 0), r.beginPath(), r.moveTo(_, w), r.lineTo(x, S), r.stroke()
                    }
                }
            }
        }),
    ...
    var ui = ht.noop,
        ...
        pi = hi.extend({
            getRightValue: function (t) {
                return "string" == typeof t ? +t : hi.prototype.getRightValue.call(this, t)
            },
            handleTickRangeOptions: function () {
                ...
                void 0 !== e.min ? t.min = e.min : void 0 !== e.suggestedMin && (null === t.min ? t.min = e.suggestedMin : t.min = Math.min(t.min, e.suggestedMin)), void 0 !== e.max ? t.max = e.max : void 0 !== e.suggestedMax && (null === t.max ? t.max = e.suggestedMax : t.max = Math.max(t.max, e.suggestedMax)), o != s && t.min >= t.max && (o ? t.max = t.min + 1 : t.min = t.max - 1), t.min === t.max && (t.max++, e.beginAtZero || t.min--)
            },
            ...
            buildTicks: function () {
                var g = this,
                    ...
                    i = g.ticks = function () {
                        ...
                        (n = Math.ceil(u / f) - Math.floor(d / f)) > a && (f = ht.niceNum(n * f / a / r) * r), s || fi(h) ? t = Math.pow(10, ht._decimalPlaces(f)) : (t = Math.pow(10, h), f = Math.ceil(f * t) / t), e = Math.floor(d / f) * f, i = Math.ceil(u / f) * f, s && (!fi(l) && ht.almostWhole(l / f, f / 1e3) && (e = l), !fi(c) && ht.almostWhole(c / f, f / 1e3) && (i = c)), n = (i - e) / f, n = ht.almostEquals(n, Math.round(n), f / 1e3) ? Math.round(n) : Math.ceil(n), e = Math.round(e * t) / t, i = Math.round(i * t) / t, o.push(fi(l) ? e : l);
                        for (var p = 1; p < n; ++p) o.push(Math.round((e + p * f) * t) / t);
                        return o.push(fi(c) ? i : c), o
                    }();
                g.handleDirectionalChanges(), g.max = ht.max(i), g.min = ht.min(i), t.reverse ? (i.reverse(), g.start = g.max, g.end = g.min) : (g.start = g.min, g.end = g.max)
            },
            convertTicksToLabels: function () {
                this.ticksAsNumbers = this.ticks.slice(), this.zeroLineIndex = this.ticks.indexOf(0), hi.prototype.convertTicksToLabels.call(this)
            }
        }),
        gi = {
            position: "left",
                ...
                if (void 0 === n && ht.each(t, function (t, e) {
                    ...
                    ht.each(t, function (t, e) {
                        var n = l.getDatasetMeta(e),
                            i = [n.type, void 0 === a.stacked && void 0 === n.stack ? e : "", n.stack].join(".");
                        void 0 === h[i] && (h[i] = {
                            positiveValues: [],
                            negativeValues: []
                        });
                        ...
                        l.isDatasetVisible(e) && c(n) && ht.each(t.data, function (t, e) {
                            var i = +r.getRightValue(t);
                            isNaN(i) || n.data[e].hidden || (o[e] = o[e] || 0, s[e] = s[e] || 0, a.relativePoints ? o[e] = 100 : i < 0 ? s[e] += i : o[e] += i)
                        })
    ...
    var xi = hi.extend({
            determineDataLimits: function () {
                ...
                if (void 0 === n && ht.each(t, function (t, e) {
                        if (!n) {
                            ...
                            a.isDatasetVisible(e) && l(i) && void 0 !== i.stack && (n = !0)
                        }
                    }), i.stacked || n) {
                    var c = {};
                    ht.each(t, function (t, e) {
                        var o = a.getDatasetMeta(e),
                            s = [o.type, void 0 === i.stacked && void 0 === o.stack ? e : "", o.stack].join(".");
                        a.isDatasetVisible(e) && l(o) && (void 0 === c[s] && (c[s] = []), ht.each(t.data, function (t, e) {
                            var i = c[s],
                                n = +r.getRightValue(t);
                            isNaN(n) || o.data[e].hidden || n < 0 || (i[e] = i[e] || 0, i[e] += n)
                        }))
                    ...
                    a.isDatasetVisible(e) && l(n) && ht.each(t.data, function (t, e) {
                        var i = +r.getRightValue(t);
            ...
            handleTickRangeOptions: function () {
                var t = this,
                    e = t.options.ticks;
                t.min = _i(e.min, t.min), t.max = _i(e.max, t.max), t.min === t.max && (0 !== t.min && null !== t.min ? (t.min = Math.pow(10, Math.floor(ht.log10(t.min)) - 1), t.max = Math.pow(10, Math.floor(ht.log10(t.max)) + 1)) : (t.min = 1, t.max = 10)), null === t.min && (t.min = Math.pow(10, Math.floor(ht.log10(t.max)) - 1)), null === t.max && (t.max = 0 !== t.min ? Math.pow(10, Math.floor(ht.log10(t.min)) + 1) : 10), null === t.minNotZero && (0 < t.min ? t.minNotZero = t.min : t.max < 1 ? t.minNotZero = Math.pow(10, Math.floor(ht.log10(t.max))) : t.minNotZero = 1)
            },
            buildTicks: function () {
                var t = this,
                    e = t.options.ticks,
                    ...
                    o = t.ticks = function (t, e) {
                        ...
                        0 === s ? (i = Math.floor(ht.log10(e.minNotZero)), n = Math.floor(e.minNotZero / Math.pow(10, i)), o.push(s), s = n * Math.pow(10, i)) : (i = Math.floor(ht.log10(s)), n = Math.floor(s / Math.pow(10, i)));
                        for (var l = i < 0 ? Math.pow(10, Math.abs(i)) : 1; o.push(s), 10 == ++n && (n = 1, l = 0 <= ++i ? 1 : l), s = Math.round(n * Math.pow(10, i) * l) / l, i < r || i === r && n < a;);
                        var c = bi(t.max, s);
                        return o.push(c), o
                    }(n, t);
                t.max = ht.max(o), t.min = ht.min(o), e.reverse ? (i = !i, t.start = t.max, t.end = t.min) : (t.start = t.min, t.end = t.max), i && o.reverse()
            },
            convertTicksToLabels: function () {
                this.tickValues = this.ticks.slice(), hi.prototype.convertTicksToLabels.call(this)
            },
            getLabelForIndex: function (t, e) {
                return +this.getRightValue(this.chart.data.datasets[e].data[t])
            },
            ...
            getPixelForValue: function (t) {
                var e, i, n, o, s, r = this,
                    ...
                    d = 0;
                return t = +r.getRightValue(t), s = l ? (n = r.end, o = r.start, -1) : (n = r.start, o = r.end, 1), i = r.isHorizontal() ? (e = r.width, l ? r.right : r.left) : (e = r.height, s *= -1, l ? r.top : r.bottom), t !== n && (0 === n && (e -= d = bi(a.fontSize, at.global.defaultFontSize), n = h), 0 !== t && (d += e / (c(o) - c(n)) * (c(t) - c(n))), i += s * d), i
            },
            getValueForPixel: function (t) {
                var e, i, n, o, s = this,
                    r = s.options.ticks,
                ...
                if (n = a ? (i = s.end, s.start) : (i = s.start, s.end), (o = s.isHorizontal() ? (e = s.width, a ? s.right - t : t - s.left) : (e = s.height, a ? t - s.top : s.bottom - t)) !== i) {
                    if (0 === i) {
    ...
    function Ei(t) {
        var e = t.ticks;
        return e.display && t.display ? Si(e.fontSize, at.global.defaultFontSize) + 2 * e.backdropPaddingY : 0
    }
    ...
    var Di = pi.extend({
                ...
                ht.each(i.data.datasets, function (t, e) {
                    if (i.isDatasetVisible(e)) {
                        ...
                        ht.each(t.data, function (t, e) {
                            ...
                            isNaN(i) || n.data[e].hidden || (s = Math.min(i, s), r = Math.max(i, r))
                        })
                    }
                }), o.min = s === Number.POSITIVE_INFINITY ? 0 : s, o.max = r === Number.NEGATIVE_INFINITY ? 0 : r, o.handleTickRangeOptions()
            },
            _computeTickLimit: function () {
                return Math.ceil(this.drawingArea / Ei(this.options))
            },
            convertTicksToLabels: function () {
                pi.prototype.convertTicksToLabels.call(this), this.pointLabels = this.chart.data.labels.map(this.options.pointLabels.callback, this)
            },
            getLabelForIndex: function (t, e) {
                return +this.getRightValue(this.chart.data.datasets[e].data[t])
            },
            fit: function () {
                ...
                t.display && t.pointLabels.display ? function (t) {
                    var e, i, n, o = ht.options._parseFont(t.options.pointLabels),
                        s = {
                            l: 0,
                            r: t.width,
                            t: 0,
                    ...
                    var a, l, c, h = Ii(t);
                    for (e = 0; e < h; e++) {
                        n = t.getPointPosition(e, t.drawingArea + 5), a = t.ctx, l = o.lineHeight, c = t.pointLabels[e] || "", i = ht.isArray(c) ? {
                            w: ht.longestText(a, a.font, c),
                            h: c.length * l
                        } : {
                        ...
                        f.start < s.l && (s.l = f.start, r.l = d), f.end > s.r && (s.r = f.end, r.r = d), p.start < s.t && (s.t = p.start, r.t = d), p.end > s.b && (s.b = p.end, r.b = d)
                    }
            ...
            setReductions: function (t, e, i) {
                ...
                n = Pi(n), o = Pi(o), s = Pi(s), r = Pi(r), this.drawingArea = Math.min(Math.floor(t - (n + o) / 2), Math.floor(t - (s + r) / 2)), this.setCenterPoint(n, o, s, r)
            },
            setCenterPoint: function (t, e, i, n) {
                ...
                o.xCenter = Math.floor((r + s) / 2 + o.left), o.yCenter = Math.floor((a + l) / 2 + o.top + o.paddingTop)
            },
                ...
                if (t.display) {
                    ...
                    (t.angleLines.display || t.pointLabels.display) && function (t) {
                        var e = t.ctx,
                            ...
                            l = Ei(i);
                        e.save(), e.lineWidth = r, e.strokeStyle = a, e.setLineDash && (e.setLineDash(Ti([n.borderDash, o.borderDash, []])), e.lineDashOffset = Ti([n.borderDashOffset, o.borderDashOffset, 0]));
                        var c, h, d, u, f = t.getDistanceFromCenterForValue(i.ticks.reverse ? t.min : t.max),
                        ...
                        for (var g = Ii(t) - 1; 0 <= g; g--) {
                            ...
                            if (s.display) {
                                ...
                                var _ = t.getIndexAngle(g),
                                    x = ht.toDegrees(_);
                                e.textAlign = 0 === (u = x) || 180 === u ? "center" : u < 180 ? "left" : "right", c = x, h = t._pointLabelSizes[g], d = b, 90 === c || 270 === c ? d.y -= h.h / 2 : (270 < c || c < 90) && (d.y -= h.h), Ai(e, t.pointLabels[g] || "", b, p.lineHeight)
                            }
                        }
                        e.restore()
                    }(s), ht.each(s.ticks, function (t, e) {
                        if (0 < e || a.reverse) {
                            ...
                            if (r.display && 0 !== e && function (t, e, i, n) {
                                    ...
                                    if ((r || a) && l && c) {
                                        if (s.save(), s.strokeStyle = l, s.lineWidth = c, s.setLineDash && (s.setLineDash(e.borderDash || []), s.lineDashOffset = e.borderDashOffset || 0), s.beginPath(), r) s.arc(t.xCenter, t.yCenter, i, 0, 2 * Math.PI);
                                        else {
                                            o = t.getPointPosition(0, i), s.moveTo(o.x, o.y);
                                            for (var h = 1; h < a; h++) o = t.getPointPosition(h, i), s.lineTo(o.x, o.y)
                                        }
                                        s.closePath(), s.stroke(), s.restore()
                                    }
                                }(s, r, i, e), a.display) {
                                var n = Si(a.fontColor, at.global.defaultFontColor);
                                if (l.font = h.string, l.save(), l.translate(s.xCenter, s.yCenter), l.rotate(c), a.showLabelBackdrop) {
                                    var o = l.measureText(t).width;
                                    l.fillStyle = a.backdropColor, l.fillRect(-o / 2 - a.backdropPaddingX, -i - h.size / 2 - a.backdropPaddingY, o + 2 * a.backdropPaddingX, h.size + 2 * a.backdropPaddingY)
                                }
    ...
    function Hi(t) {
        var e, i, n, o = {},
            s = [];
        for (e = 0, i = t.length; e < i; ++e) o[n = t[e]] || (o[n] = !0, s.push(n));
        return s
    }
    ...
    function ji(t, e, i, n) {
        var o = function (t, e, i) {
                for (var n, o, s, r = 0, a = t.length - 1; 0 <= r && r <= a;) {
                    if (o = t[(n = r + a >> 1) - 1] || null, s = t[n], !o) return {
                        lo: null,
                        hi: s
                    };
                    if (s[e] < i) r = 1 + n;
    ...
    function Wi(t, e) {
        var i = t._adapter,
            ...
            s = o || n.format,
            r = e;
        return "function" == typeof o && (r = o(r)), ht.isFinite(r) || (r = "string" == typeof s ? i.parse(r, s) : i.parse(r)), null !== r ? +r : (o || "function" != typeof s || (r = s(e), ht.isFinite(r) || (r = i.parse(r))), r)
    }
    ...
    var Vi = hi.extend({
        ...
        update: function () {
            ...
            return e.format && console.warn("options.time.format is deprecated and replaced by options.time.parser."), ht.mergeIf(e.displayFormats, i.formats()), hi.prototype.update.apply(this, arguments)
        },
        getRightValue: function (t) {
            return t && void 0 !== t.t && (t = t.t), hi.prototype.getRightValue.call(this, t)
        },
        determineDataLimits: function () {
            ...
            for (t = 0, i = (a.data.datasets || []).length; t < i; ++t)
                if (a.isDatasetVisible(t))
                    if (o = a.data.datasets[t].data, ht.isObject(o[0]))
                        for (p[t] = [], e = 0, n = o.length; e < n; ++e) s = Bi(r, o[e]), f.push(s), p[t][e] = s;
                    else {
                        for (e = 0, n = g.length; e < n; ++e) f.push(g[e]);
                        p[t] = g.slice(0)
                    }
            else p[t] = [];
            g.length && (g = Hi(g).sort(Ni), d = Math.min(d, g[0]), u = Math.max(u, g[g.length - 1])), f.length && (f = Hi(f).sort(Ni), d = Math.min(d, f[0]), u = Math.max(u, f[f.length - 1])), d = Bi(r, c.min) || d, u = Bi(r, c.max) || u, d = d === Fi ? +l.startOf(Date.now(), h) : d, u = u === Li ? +l.endOf(Date.now(), h) + 1 : u, r.min = Math.min(d, u), r.max = Math.max(d + 1, u), r._horizontal = r.isHorizontal(), r._table = [], r._timestamps = {
                data: f,
                datasets: p,
                labels: g
            }
        ...
        buildTicks: function () {
            var t, e, i, n, o, s, r, a, l, c, h = this,
                d = h.min,
                u = h.max,
                f = h.options,
                p = f.time,
                ...
                default:
                    g = function (t, l, c, e) {
                        var i, n = t._adapter,
                            o = t.options,
                            s = o.time,
                            h = s.unit || function (t, e, i, n) {
                                var o, s, r, a = Ri.length;
                                for (o = Ri.indexOf(t); o < a - 1; ++o)
                                    if (r = (s = zi[Ri[o]]).steps ? s.steps[s.steps.length - 1] : Fi, s.common && Math.ceil((i - e) / (r * s.size)) <= n) return Ri[o];
                                return Ri[a - 1]
                            }(s.minUnit, l, c, e),
                            r = qi(h),
                        ...
                        for (a = a || function (t) {
                                ...
                                for (e = 0, i = a.length; e < i && (n = a[e], !(Math.ceil(o / (r * n)) <= t)); ++e);
                                return n
                            }(e), d && (p = +n.startOf(p, "isoWeek", d), g = +n.startOf(g, "isoWeek", d)), p = +n.startOf(p, d ? "day" : h), (g = +n.startOf(g, d ? "day" : h)) < c && (g = +n.add(g, 1, h)), i = p, u && r && !d && !s.round && (i = +n.startOf(i, r), i = +n.add(i, ~~((p - i) / (f.size * a)) * a, h)); i < g; i = +n.add(i, a, h)) m.push(+i);
                        return m.push(+i), m
                    }(h, d, u, h.getLabelCapacity(d))
            }
            for ("ticks" === f.bounds && g.length && (d = g[0], u = g[g.length - 1]), d = Bi(h, p.min) || d, u = Bi(h, p.max) || u, t = 0, e = g.length; t < e; ++t)(i = g[t]) >= d && i <= u && m.push(i);
            return h.min = d, h.max = u, h._unit = p.unit || function (t, e, i, n, o) {
                    var s, r;
                    for (s = Ri.length - 1; s >= Ri.indexOf(i); s--)
                        if (r = Ri[s], zi[r].common && t._adapter.diff(o, n, r) >= e.length) return r;
                    return Ri[i ? Ri.indexOf(i) : 0]
                }(h, m, p.minUnit, h.min, h.max), h._majorUnit = qi(h._unit), h._table = function (t, e, i) {
                    ...
                    var n, o, s, r, a, l = [],
                        c = [e];
                    for (n = 0, o = t.length; n < o; ++n)(r = t[n]) > e && r < i && c.push(r);
                    for (c.push(i), n = 0, o = c.length; n < o; ++n) a = c[n + 1], s = c[n - 1], r = c[n], void 0 !== s && void 0 !== a && Math.round((a + s) / 2) === r || l.push({
                        time: r,
                        pos: n / (o - 1)
                    });
                    return l
                }(h._timestamps.data, d, u), h._offsets = (n = h._table, o = m, c = l = 0, (s = f).offset && o.length && (s.time.min || (r = ji(n, "time", o[0], "pos"), l = 1 === o.length ? 1 - r : (ji(n, "time", o[1], "pos") - r) / 2), s.time.max || (a = ji(n, "time", o[o.length - 1], "pos"), c = 1 === o.length ? a : (a - ji(n, "time", o[o.length - 2], "pos")) / 2)), {
                    start: l,
                    end: c
                }), f.ticks.reverse && m.reverse(),
                function (t, e, i) {
                    var n, o, s, r, a = [];
                    for (n = 0, o = e.length; n < o; ++n) s = e[n], r = !!i && s === +t._adapter.startOf(s, i), a.push({
                        value: s,
                        major: r
                    });
                    return a
        ...
        getLabelForIndex: function (t, e) {
            ...
            return ht.isObject(r) && (s = this.getRightValue(r)), o.tooltipFormat ? i.format(Wi(this, s), o.tooltipFormat) : "string" == typeof s ? s : i.format(Wi(this, s), o.displayFormats.datetime)
        },
        ...
        getPixelForOffset: function (t) {
            var e = this,
                ...
                r = n * (e._offsets.start + s) / (e._offsets.start + 1 + e._offsets.end);
            return i ? o - r : o + r
        },
        getPixelForValue: function (t, e, i) {
            var n = null;
            if (void 0 !== e && void 0 !== i && (n = this._timestamps.datasets[i][e]), null === n && (n = Bi(this, t)), null !== n) return this.getPixelForOffset(n)
        },
        getPixelForTick: function (t) {
            var e = this.getTicks();
        ...
        getValueForPixel: function (t) {
            var e = this,
                ...
                o = (i ? (t - n) / i : 0) * (e._offsets.start + 1 + e._offsets.start) - e._offsets.end,
    ...
    oi._date.override("function" == typeof n ? {
        _id: "moment",
        formats: function () {
            return Yi
        },
    ...
    function Qi(t, e, i) {
        var n, o = t._model || {},
            s = o.fill;
        if (void 0 === s && (s = !!o.backgroundColor), !1 === s || null === s) return !1;
        if (!0 === s) return "origin";
        if (n = parseFloat(s, 10), isFinite(n) && Math.floor(n) === n) return "-" !== s[0] && "+" !== s[0] || (n = e + n), !(n === e || n < 0 || i <= n) && n;
        switch (s) {
            case "bottom":
                return "start";
            case "top":
    ...
    function Ki(t) {
        ...
        if ("start" === o ? s = void 0 === i.scaleBottom ? n.bottom : i.scaleBottom : "end" === o ? s = void 0 === i.scaleTop ? n.top : i.scaleTop : void 0 !== i.scaleZero ? s = i.scaleZero : n.getBasePosition ? s = n.getBasePosition() : n.getBasePixel && (s = n.getBasePixel()), null != s) {
            if (void 0 !== s.x && void 0 !== s.y) return s;
            if (ht.isFinite(s)) return {
                x: (e = n.isHorizontal()) ? s : null,
                y: e ? null : s
            }
        }
        return null
    ...
    function Ji(t, e, i, n, o) {
        var s;
        if (n && o) {
            for (t.moveTo(e[0].x, e[0].y), s = 1; s < n; ++s) ht.canvas.lineTo(t, e[s - 1], e[s]);
            for (t.lineTo(i[o - 1].x, i[o - 1].y), s = o - 1; 0 < s; --s) ht.canvas.lineTo(t, i[s], i[s - 1], !0)
        }
    }
    var tn = {
            id: "filler",
            afterDatasetsUpdate: function (t, e) {
                var i, n, o, s, r, a, l, c = (t.data.datasets || []).length,
                    h = e.propagate,
                    d = [];
                for (n = 0; n < c; ++n) s = null, (o = (i = t.getDatasetMeta(n)).dataset) && o._model && o instanceof Rt.Line && (s = {
                    visible: t.isDatasetVisible(n),
                    fill: Qi(o, n, c),
                    chart: t,
                    el: o
                }), i.$filler = s, d.push(s);
                for (n = 0; n < c; ++n)(s = d[n]) && (s.fill = Gi(d, n, h), s.boundary = Ki(s), s.mapper = (l = void 0, a = (r = s).fill, !(l = "dataset") === a ? null : (isFinite(a) || (l = "boundary"), Xi[l](r))))
            },
            beforeDatasetDraw: function (t, e) {
                ...
                if (i) {
                    ...
                    a && l && r.length && (ht.canvas.clipArea(n, t.chartArea), function (t, e, i, n, o, s) {
                        var r, a, l, c, h, d, u, f = e.length,
                            p = n.spanGaps,
                            g = [],
                            m = [],
                            v = 0,
                            b = 0;
                        for (t.beginPath(), r = 0, a = f + !!s; r < a; ++r) h = i(c = e[l = r % f]._view, l, n), d = Zi(c), u = Zi(h), d && u ? (v = g.push(c), b = m.push(h)) : v && b && (p ? (d && g.push(c), u && m.push(h)) : (Ji(t, g, m, v, b), v = b = 0, g = [], m = []));
                        Ji(t, g, m, v, b), t.closePath(), t.fillStyle = o, t.fill()
                    }(n, r, a, s, l, o._loop), ht.canvas.unclipArea(n))
                }
            }
        },
        en = ht.noop,
            ...
            if (c ? (l.width = t.maxWidth, l.height = i ? 10 : 0) : (l.width = i ? 10 : 0, l.height = t.maxHeight), i)
                if (o.font = s.string, c) {
                    var h = t.lineWidths = [0],
                        d = 0;
                    o.textAlign = "left", o.textBaseline = "top", ht.each(t.legendItems, function (t, e) {
                        var i = on(n, r) + r / 2 + o.measureText(t.text).width;
                        (0 === e || h[h.length - 1] + i + n.padding > l.width) && (d += r + n.padding, h[h.length - (0 < e ? 0 : 1)] = n.padding), a[e] = {
                            left: 0,
                            top: 0,
                            width: i,
                            height: r
                    ...
                    ht.each(t.legendItems, function (t, e) {
                        var i = on(n, r) + r / 2 + o.measureText(t.text).width;
                        0 < e && m + v > l.height - u && (p += g + n.padding, f.push(g), m = g = 0), g = Math.max(g, i), m += v, a[e] = {
                            left: 0,
                            top: 0,
                            width: i,
                            height: r
        ...
        draw: function () {
            ...
            if (u.display) {
                ...
                ht.each(d.legendItems, function (t, e) {
                    var i, n, o, s, r, a = y.measureText(t.text).width,
                        l = x + _ / 2 + a,
                        c = b.x,
                        h = b.y;
                    S ? 0 < e && c + l + f.padding > d.left + d.minSize.width && (h = b.y += k, b.line++, c = b.x = d.left + (m - v[b.line]) / 2 + f.padding) : 0 < e && h + k > d.top + d.minSize.height && (c = b.x = c + d.columnWidths[b.line] + f.padding, h = b.y = d.top + f.padding, b.line++),
                        function (t, e, i) {
                            if (!(isNaN(x) || x <= 0)) {
                                y.save();
                                var n = nn(i.lineWidth, g.borderWidth);
                                if (y.fillStyle = nn(i.fillStyle, p), y.lineCap = nn(i.lineCap, g.borderCapStyle), y.lineDashOffset = nn(i.lineDashOffset, g.borderDashOffset), y.lineJoin = nn(i.lineJoin, g.borderJoinStyle), y.lineWidth = n, y.strokeStyle = nn(i.strokeStyle, p), y.setLineDash && y.setLineDash(nn(i.lineDash, g.borderDash)), u.labels && u.labels.usePointStyle) {
                                    var o = x * Math.SQRT2 / 2,
                                        s = t + x / 2,
                                        r = e + _ / 2;
                                    ht.canvas.drawPoint(y, i.pointStyle, o, s, r)
                                } else 0 !== n && y.strokeRect(t, e, x, _), y.fillRect(t, e, x, _);
                                y.restore()
                            }
                        }(c, h, t), w[e].left = c, w[e].top = h, i = t, n = a, s = x + (o = _ / 2) + c, r = h + o, y.fillText(i.text, s, r), i.hidden && (y.beginPath(), y.lineWidth = 2, y.moveTo(s, r), y.lineTo(s + n, r), y.stroke()), S ? b.x += l + f.padding : b.y += k
                })
            }
        },
        _getLegendItemAt: function (t, e) {
            ...
            if (t >= this.left && t <= this.right && e >= this.top && e <= this.bottom)
                for (o = this.legendHitBoxes, i = 0; i < o.length; ++i)
                    if (t >= (n = o[i]).left && t <= n.left + n.width && e >= n.top && e <= n.top + n.height) return this.legendItems[i];
            return null
        },
        handleEvent: function (t) {
    ...
    var an = {
            ...
            beforeUpdate: function (t) {
                var e = t.options.legend,
                    i = t.legend;
                e ? (ht.mergeIf(e, at.global.legend), i ? (xe.configure(t, i, e), i.options = e) : rn(t, e)) : i && (xe.removeBox(t, i), delete t.legend)
            },
    ...
    var cn = gt.extend({
        ...
        fit: function () {
            ...
            this.isHorizontal() ? (i.width = this.maxWidth, i.height = s) : (i.width = s, i.height = this.maxHeight), this.width = i.width, this.height = i.height
        },
        afterFit: ln,
        isHorizontal: function () {
        ...
        draw: function () {
            var t = this.ctx,
                e = this.options;
            if (e.display) {
                var i, n, o, s = ht.options._parseFont(e),
                    r = s.lineHeight,
                    a = r / 2 + e.padding,
                    l = 0,
                    c = this.top,
                    ...
                    d = this.bottom,
                    u = this.right;
                t.fillStyle = ht.valueOrDefault(e.fontColor, at.global.defaultFontColor), t.font = s.string, this.isHorizontal() ? (n = h + (u - h) / 2, o = c + a, i = u - h) : (n = "left" === e.position ? h + a : u - a, o = c + (d - c) / 2, i = d - c, l = Math.PI * ("left" === e.position ? -.5 : .5)), t.save(), t.translate(n, o), t.rotate(l), t.textAlign = "center", t.textBaseline = "middle";
                var f = e.text;
                if (ht.isArray(f))
                    for (var p = 0, g = 0; g < f.length; ++g) t.fillText(f[g], 0, p, i), p += r;
    ...
    var dn = {},
        ...
        pn = {
            ...
            beforeUpdate: function (t) {
                var e = t.options.title,
                    i = t.titleBlock;
                e ? (ht.mergeIf(e, at.global.title), i ? (xe.configure(t, i, e), i.options = e) : hn(t, e)) : i && (xe.removeBox(t, i), delete t.titleBlock)
            }
        };
    for (var gn in dn.filler = un, dn.legend = fn, dn.title = pn, (ei.helpers = ht).where = function (t, e) {
            ...
            var e, i, n, o, s, r, a, l, c, h = (t || []).map(function (t) {
                    return {
                        model: t._model,
                        deltaK: 0,
                        mK: 0
            ...
            for (e = 0; e < d; ++e)
                if (!(n = h[e]).model.skip) {
                    if (i = 0 < e ? h[e - 1] : null, (o = e < d - 1 ? h[e + 1] : null) && !o.model.skip) {
                ...
                } for (e = 0; e < d - 1; ++e) n = h[e], o = h[e + 1], n.model.skip || o.model.skip || (ht.almostEquals(n.deltaK, 0, this.EPSILON) ? n.mK = o.mK = 0 : (s = n.mK / n.deltaK, r = o.mK / n.deltaK, (l = Math.pow(s, 2) + Math.pow(r, 2)) <= 9 || (a = 3 / Math.sqrt(l), n.mK = s * a * n.deltaK, o.mK = r * a * n.deltaK)));
            for (e = 0; e < d; ++e)(n = h[e]).model.skip || (i = 0 < e ? h[e - 1] : null, o = e < d - 1 ? h[e + 1] : null, i && !i.model.skip && (c = (n.model.x - i.model.x) / 3, n.model.controlPointPreviousX = n.model.x - c, n.model.controlPointPreviousY = n.model.y - c * n.mK), o && !o.model.skip && (c = (o.model.x - n.model.x) / 3, n.model.controlPointNextX = n.model.x + c, n.model.controlPointNextY = n.model.y + c * n.mK))
            ...
            var i, n, o = t.originalEvent || t,
                ...
                a = o.touches;
            n = a && 0 < a.length ? (i = a[0].clientX, a[0].clientY) : (i = o.clientX, o.clientY);
            ...
            return {
                x: i = Math.round((i - r.left - l) / u * s.width / e.currentDevicePixelRatio),
                y: n = Math.round((n - r.top - c) / f * s.height / e.currentDevicePixelRatio)
            }
            ...
            if (1 !== i) {
                var n = t.canvas,
                    o = t.height,
                    s = t.width;
                n.height = o * i, n.width = s * i, t.ctx.scale(i, i), n.style.height || n.style.width || (n.style.height = o + "px", n.style.width = s + "px")
            }
            ...
            ht.each(i, function (t) {
                null != t && !0 !== ht.isArray(t) ? r = ht.measureText(e, o, s, r, t) : ht.isArray(t) && ht.each(t, function (t) {
        ...
        }, ht.color = Y ? function (t) {
            return t instanceof CanvasGradient && (t = at.global.defaultColor), Y(t)
        } : function (t) {
        ...
        }, ei._adapters = oi, ei.Animation = vt, ei.animationService = bt, ei.controllers = ce, ei.DatasetController = St, ei.defaults = at, ei.Element = gt, ei.elements = Rt, ei.Interaction = me, ei.layouts = xe, ei.platform = ze, ei.plugins = Re, ei.Scale = hi, ei.scaleService = Ne, ei.Ticks = si, ei.Tooltip = Qe, ei.helpers.each(Ui, function (t, e) {
            ei.scaleService.registerScaleType(e, t, t._defaults)
        }), dn) dn.hasOwnProperty(gn) && ei.plugins.register(dn[gn]);
    ...
    function bn(t, e, i) {
        ...
        return a || l ? Math.min(a ? mn(s, t, i) : c, l ? mn(r, o, i) : c) : "none"
    }
    ei.platform.initialize();
    var yn = ei;
    return "undefined" != typeof window && (window.Chart = ei), (ei.Chart = ei).Legend = dn.legend._element, ei.Title = dn.title._element, ei.pluginService = ei.plugins, ei.PluginBase = ei.Element.extend({}), ei.canvasHelpers = ei.helpers.canvas, ei.layoutService = ei.layouts, ei.LinearScaleBase = pi, ei.helpers.each(["Bar", "Bubble", "Doughnut", "Line", "PolarArea", "Radar", "Scatter"], function (i) {
        ei[i] = function (t, e) {
    ...
    if (h.console = h.console || {
        ...
        g.extend(n.prototype, {
            ...
            addEvents: function () {
                ...
                }), n.group[n.currIndex].opts.idleTime && (n.idleSecondsCounter = 0, s.on("mousemove.fb-idle mouseleave.fb-idle mousedown.fb-idle touchstart.fb-idle touchmove.fb-idle scroll.fb-idle keydown.fb-idle", function (t) {
            ...
            removeEvents: function () {
                o.off("orientationchange.fb resize.fb"), s.off("focusin.fb keydown.fb .fb-idle"), this.$refs.container.off(".fb-close .fb-prev .fb-next"), this.idleInterval && (h.clearInterval(this.idleInterval), this.idleInterval = null)
            },
            previous: function (t) {
            ...
            updateCursor: function (t, e) {
                ...
                n && !this.isClosing && (i = this.isZoomable(), o.toggleClass("fancybox-is-zoomable", i), g("[data-fancybox-zoom]").prop("disabled", !i), i && ("zoom" === n.opts.clickContent || g.isFunction(n.opts.clickContent) && "zoom" === n.opts.clickContent(n)) ? this.isScaledDown(t, e) ? o.addClass("fancybox-can-zoomIn") : n.opts.touch ? o.addClass("fancybox-can-drag") : o.addClass("fancybox-can-zoomOut") : n.opts.touch && "video" !== n.contentType && o.addClass("fancybox-can-drag"))
            },
            isZoomable: function () {
            ...
            revealContent: function (e) {
                ...
                })) : (s.updateSlide(e), t ? (g.fancybox.stop(r), i = "fancybox-animated fancybox-slide--" + (e.pos >= s.prevPos ? "next" : "previous") + " fancybox-fx-" + t, r.removeAttr("style").removeClass("fancybox-slide--current fancybox-slide--next fancybox-slide--previous").addClass(i), e.$content.removeClass("fancybox-is-hidden"), p(r), void g.fancybox.animate(r, "fancybox-slide--current", n, function (t) {
            ...
            complete: function () {
                var i = this,
                    t = i.current,
                    n = {};
                !t.isMoved && t.isLoaded && (t.isComplete || (t.isComplete = !0, t.$slide.siblings().trigger("onReset"), i.preload("inline"), p(t.$slide), t.$slide.addClass("fancybox-slide--complete"), g.each(i.slides, function (t, e) {
            ...
            close: function (t, e) {
                ...
                return !h.isClosing && (!(h.isClosing = !0) === h.trigger("beforeClose", t) ? (h.isClosing = !1, u(function () {
                    h.update()
                }), !1) : (h.removeEvents(), d.timouts && clearTimeout(d.timouts), s = d.$content, n = d.opts.animationEffect, o = g.isNumeric(e) ? e : n ? d.opts.animationDuration : 0, d.$slide.off(f).removeClass("fancybox-slide--complete fancybox-slide--next fancybox-slide--previous fancybox-animated"), d.$slide.siblings().trigger("onReset").remove(), o && h.$refs.container.removeClass("fancybox-is-open").addClass("fancybox-is-closing"), h.hideLoading(d), h.hideControls(), h.updateCursor(), "zoom" !== n || !0 !== t && s && o && "image" === d.type && !d.hasError && (c = h.getThumbPos(d)) || (n = "fade"), "zoom" === n ? (g.fancybox.stop(s), l = {
                    ...
                    width: c.width,
                    height: c.height
                }, "auto" == (a = d.opts.zoomOpacity) && (a = .1 < Math.abs(d.width / d.height - c.width / c.height)), a && (c.opacity = 0), g.fancybox.setTranslate(s, l), p(s), g.fancybox.animate(s, c, o, i)) : n && o ? !0 === t ? setTimeout(i, o) : g.fancybox.animate(d.$slide.removeClass("fancybox-slide--current"), "fancybox-animated fancybox-slide--previous fancybox-fx-" + n, o, i) : i(), !0))
            },
            cleanUp: function (t) {
                var e, i = g("body");
                this.current.$slide.trigger("onReset"), this.$refs.container.empty().remove(), this.trigger("afterClose", t), this.$lastFocus && this.current.opts.backFocus && this.$lastFocus.trigger("focus"), this.current = null, (e = g.fancybox.getInstance()) ? e.activate() : (i.removeClass("fancybox-active compensate-for-scrollbar"), g("#fancybox-style-noscroll").remove())
            },
            trigger: function (t, e) {
                var i, n = Array.prototype.slice.call(arguments, 1),
                    o = e && e.opts ? e : this.current;
                return o ? n.unshift(o) : o = this, n.unshift(this), g.isFunction(o.opts[t]) && (i = o.opts[t].apply(o, n)), !1 === i ? i : void("afterClose" !== t && this.$refs ? this.$refs.container.trigger(t + ".fb", n) : s.trigger(t + ".fb", n))
            },
            ...
            animate: function (e, i, t, n, o) {
                var s = !1;
                g.isFunction(t) && (n = t, t = null), g.isPlainObject(i) || e.removeAttr("style"), g.fancybox.stop(e), e.on(f, function (t) {
        ...
        }, s.on("click.fb-start", "[data-fancybox]", i), s.on("click.fb-start", "[data-trigger]", function (t) {
            i(t, {
...
function (f) {
    ...
    f(document).on("objectNeedsType.fb", function (t, e, o) {
        var i, s, r, a, l, c, h, d = o.src || "",
            u = !1;
        i = f.extend(!0, {}, n, o.opts.media), f.each(i, function (t, e) {
            if (r = d.match(e.matcher)) {
                ...
                return a = f.extend(!0, {}, e.params, o.opts[t], c), d = "function" === f.type(e.url) ? e.url.call(this, r, a, o) : p(e.url, r, a), s = "function" === f.type(e.thumb) ? e.thumb.call(this, r, a, o) : p(e.thumb, r), "youtube" === t ? d = d.replace(/&t=((\d+)m)?(\d+)s/, function (t, e, i, n) {
                    return "&start=" + ((i ? 60 * parseInt(i, 10) : 0) + parseInt(n, 10))
                }) : "vimeo" === t && (d = d.replace("&%23", "#")), !1
            }
        }), u ? (o.opts.thumb || o.opts.$thumb && o.opts.$thumb.length || (o.opts.thumb = s), "iframe" === u && (o.opts = f.extend(!0, o.opts, {
            iframe: {
                preload: !1,
                attr: {
                    scrolling: "no"
...
function (g, a, m) {
    ...
    i.prototype.destroy = function () {
        ...
        var t, e, i, n, o, s, r = this.canvasWidth,
            ...
            f = h.width,
            p = h.height;
        return o = r < f ? d + l : d, s = u + c, t = Math.max(0, .5 * r - .5 * f), e = Math.max(0, .5 * a - .5 * p), i = Math.min(r - f, .5 * r - .5 * f), n = Math.min(a - p, .5 * a - .5 * p), 0 < l && t < o && (o = t - 1 + Math.pow(-t + d + l, .8) || 0), l < 0 && o < i && (o = i + 1 - Math.pow(i - d - l, .8) || 0), 0 < c && e < s && (s = e - 1 + Math.pow(-e + u + c, .8) || 0), c < 0 && s < n && (s = n + 1 - Math.pow(n - u - c, .8) || 0), {
            top: s,
            left: o
        }
        ...
        t.canTap = !1, t.newWidth = a, t.newHeight = l, t.contentLastPos = p, t.requestId && (y(t.requestId), t.requestId = null), t.requestId = b(function () {
            m.fancybox.setTranslate(t.$content, t.contentLastPos)
        })
    ...
    function y(t) {
        if (function () {
                if (!S) {
                    ...
                    e.appendChild(t);
                    var i = b(t);
                    _ = 200 == Math.round(v(i.width)), y.isBoxSizeOuter = _, e.removeChild(t)
                }
            ...
            var m = v(e.height);
            return !1 !== m && (i.height = m + (p ? 0 : c + f)), i.innerWidth = i.width - (l + u), i.innerHeight = i.height - (c + f), i.outerWidth = i.width + h, i.outerHeight = i.height + d, i
        }
    }
...
function (i) {
    ...
    (function (t) {
        ...
        function g(t) {
            v = o.window.innerWidth || document.documentElement.clientWidth, b = r ? (!d && document.body && ((d = document.createElement("div")).style.cssText = "position: fixed; top: -9999px; left: 0; height: 100vh; width: 0;", document.body.appendChild(d)), (d ? d.clientHeight : 0) || o.window.innerHeight || document.documentElement.clientHeight) : o.window.innerHeight || document.documentElement.clientHeight, "object" !== (void 0 === t ? "undefined" : c(t)) || "load" !== t.type && "dom-loaded" !== t.type || (f = !0)
        }
        ...
        function _() {
            if (m.length) {
                ...
                var e = f || !y || y.width !== v || y.height !== b,
                    i = p || e || !y || y.y !== u;
                p = f = !1, (e || i) && (m.forEach(function (t) {
        ...
        var x, w, S, k = !!t.ResizeObserver && new t.ResizeObserver(function (t) {
                t && t.length && (0, n.default)(function () {
                    t.forEach(function (t) {
                        t.target && t.target.jarallax && (f || t.target.jarallax.onResize(), p = !0)
                    })
                })
            }),
            T = 0,
            C = (x = I, (w = [{
                ...
                value: function () {
                    ...
                    i.position = t.image.position, t.css(t.image.$item, i), t.image.$container.appendChild(t.image.$item), t.onResize(), t.onScroll(!0), t.options.automaticResize && k && k.observe(t.$item), t.options.onInit && t.options.onInit.call(t), "none" !== t.css(t.$item, "background-image") && t.css(t.$item, {
                ...
                value: function () {
                    var t, e = this,
                        ...
                        r = 0,
                        a = n;
                    return s && (o < 0 ? (r = o * Math.max(n, b), b < n && (r -= o * (n - b))) : r = o * (n + b), 1 < o ? a = Math.abs(r - b) : o < 0 ? a = r / o + Math.abs(r) : a += (b - n) * (1 - o), r /= 2), e.parallaxScrollDistance = r, t = s ? (b - a) / 2 : (n - a) / 2, e.css(e.image.$item, {
                        height: a + "px",
                        marginTop: t + "px",
                ...
                value: function (t) {
                    ...
                    if (e.options.elementInViewport && (r = e.options.elementInViewport.getBoundingClientRect()), e.isElementInViewport = 0 <= r.bottom && 0 <= r.right && r.top <= b && r.left <= v, t || e.isElementInViewport) {
                        var a = Math.max(0, n),
                            ...
                            f = 1 - 2 * (b - n) / (b + o),
                            p = 1;
                        if (o < b ? p = 1 - (c || h) / o : l <= b ? p = l / b : d <= b && (p = d / b), "opacity" !== e.options.type && "scale-opacity" !== e.options.type && "scroll-opacity" !== e.options.type || (s.transform = "translate3d(0,0,0)", s.opacity = p), "scale" === e.options.type || "scale-opacity" === e.options.type) {
                            var g = 1;
                            e.options.speed < 0 ? g -= e.options.speed * p : g += e.options.speed * (1 - p), s.transform = "scale(" + g + ") translate3d(0,0,0)"
                        }
        ...
        function E(t, e) {
            ...
            for (var i = e, n = Array.prototype.slice.call(arguments, 2), o = t.length, s = 0, r = void 0; s < o; s++)
                if ("object" === (void 0 === i ? "undefined" : c(i)) || void 0 === i ? t[s].jarallax || (t[s].jarallax = new C(t[s], i)) : t[s].jarallax && (r = t[s].jarallax[i].apply(t[s].jarallax, n)), void 0 !== r) return r;
            return t
        }
...
var objectFitImages = function () {
    ...
    function a(e) {
        ...
        if (!o.img) {
            o.img = new Image(e.width, e.height), o.img.srcset = p.call(e, "data-ofi-srcset") || e.srcset, o.img.src = p.call(e, "data-ofi-src") || e.src, g.call(e, "data-ofi-src", e.src), e.srcset && g.call(e, "data-ofi-srcset", e.srcset), s(e, e.naturalWidth || e.width, e.naturalHeight || e.height), e.srcset && (e.srcset = "");
            try {
                i = e, n = {
                    get: function (t) {
...
function (t) {
    ...
    function n(t, g) {
        function e(t) {
            if (!(!0 === K.data(Dt + "_intouch") || 0 < at(t.target).closest(g.excludedElements, K).length)) {
                var e = t.originalEvent ? t.originalEvent : t;
                if (!e.pointerType || "mouse" != e.pointerType || 0 != g.fallbackToMouseEvents) {
                    var i, n = e.touches,
                        o = n ? n[0] : e;
                    return G = Tt, n ? Z = n.length : !1 !== g.preventDefaultEvents && t.preventDefault(), X = W = j = null, U = 1, Y = V = q = B = H = 0, (s = {})[lt] = M(lt), s[ct] = M(ct), s[ht] = M(ht), s[dt] = M(dt), Q = s, S(), C(0, o), !n || Z === g.fingers || g.fingers === St || b() ? (tt = $(), 2 == Z && (C(1, n[1]), q = V = P(J[0].start, J[1].start)), (g.swipeStatus || g.pinchStatus) && (i = v(e, G))) : i = !1, !1 === i ? (v(e, G = Et), i) : (g.hold && (rt = setTimeout(at.proxy(function () {
                        K.trigger("hold", [e.target]), g.hold && (i = g.hold.call(K, e, e.target))
                    }, this), g.longTapThreshold)), T(!0), null)
                }
            }
            var s
        }
        ...
        function i(t) {
            ...
            if (G !== It && G !== Et && !k()) {
                var h, d = c.touches,
                    u = I(d ? d[0] : c);
                if (et = $(), d && (Z = d.length), g.hold && clearTimeout(rt), G = Ct, 2 == Z && (0 == q ? (C(1, d[1]), q = V = P(J[0].start, J[1].start)) : (I(d[1]), V = P(J[0].end, J[1].end), J[0].end, J[1].end, X = U < 1 ? ft : ut), U = (V / q * 1).toFixed(2), Y = Math.abs(q - V)), Z === g.fingers || g.fingers === St || !d || b()) {
                    if (j = D(u.start, u.end), function (t, e) {
                            if (!1 !== g.preventDefaultEvents)
                                if (g.allowPageScroll === pt) t.preventDefault();
                                    ...
                                    switch (e) {
                                        case lt:
                                            (g.swipeLeft && i || !i && g.allowPageScroll != xt) && t.preventDefault();
                                            break;
                                        case ct:
                                            (g.swipeRight && i || !i && g.allowPageScroll != xt) && t.preventDefault();
                                            break;
                                        case ht:
                                            (g.swipeUp && i || !i && g.allowPageScroll != wt) && t.preventDefault();
                                            break;
                                        case dt:
                                            (g.swipeDown && i || !i && g.allowPageScroll != wt) && t.preventDefault()
                                    }
                                }
                        }(t, W = D(u.last, u.end)), a = u.start, l = u.end, H = Math.round(Math.sqrt(Math.pow(l.x - a.x, 2) + Math.pow(l.y - a.y, 2))), B = A(), r = H, (s = j) != pt && (r = Math.max(r, E(s)), Q[s].distance = r), h = v(c, G), !g.triggerOnTouchEnd || g.triggerOnTouchLeave) {
                        var f = !0;
                        if (g.triggerOnTouchLeave) {
                            ...
                            e = u.end, i = p, f = e.x > i.left && e.x < i.right && e.y > i.top && e.y < i.bottom
                        }!g.triggerOnTouchEnd && f ? G = m(Ct) : g.triggerOnTouchLeave && !f && (G = m(It)), G != Et && G != It || v(c, G)
                    }
                } else v(c, G = Et);
                !1 === h && v(c, G = Et)
            }
        ...
        function n(t) {
            var e, i = t.originalEvent ? t.originalEvent : t,
                n = i.touches;
            if (n) {
                if (n.length && !k()) return e = i, it = $(), nt = e.touches.length + 1, !0;
                if (n.length && k()) return !0
            }
            return k() && (Z = nt), et = $(), B = A(), c() || !l() ? v(i, G = Et) : g.triggerOnTouchEnd || !1 === g.triggerOnTouchEnd && G === Ct ? (!1 !== g.preventDefaultEvents && !1 !== t.cancelable && t.preventDefault(), v(i, G = It)) : !g.triggerOnTouchEnd && _() ? a(i, G = It, bt) : G === Ct && v(i, G = Et), T(!1), null
        }
        ...
        function r() {
            K.unbind(L, e), K.unbind(N, o), K.unbind(F, i), K.unbind(z, n), R && K.unbind(R, s), T(!1)
        }
        ...
        function m(t) {
            var e = t,
                ...
                n = l(),
                o = c();
            return !i || o ? e = Et : !n || t != Ct || g.triggerOnTouchEnd && !g.triggerOnTouchLeave ? !n && t == It && g.triggerOnTouchLeave && (e = Et) : e = It, e
        }

        function v(t, e) {
            var i, n = t.touches;
            return (u() && f() || f()) && (i = a(t, e, mt)), (d() && b() || b()) && !1 !== i && (i = a(t, e, vt)), w() && x() && !1 !== i ? i = a(t, e, yt) : B > g.longTapThreshold && H < kt && g.longTap && !1 !== i ? i = a(t, e, _t) : 1 !== Z && Mt || !(isNaN(H) || H < g.threshold) || !_() || !1 === i || (i = a(t, e, bt)), e === Et && o(), e === It && (n && n.length || o()), i
        }

        function a(t, e, i) {
            var n;
            if (i == mt) {
                if (K.trigger("swipeStatus", [e, j || null, H || 0, B || 0, Z, J, W]), g.swipeStatus && !1 === (n = g.swipeStatus.call(K, t, e, j || null, H || 0, B || 0, Z, J, W))) return !1;
                if (e == It && u()) {
                    if (clearTimeout(st), clearTimeout(rt), K.trigger("swipe", [j, H, B, Z, J, W]), g.swipe && !1 === (n = g.swipe.call(K, t, j, H, B, Z, J, W))) return !1;
                    switch (j) {
                        case lt:
                            K.trigger("swipeLeft", [j, H, B, Z, J, W]), g.swipeLeft && (n = g.swipeLeft.call(K, t, j, H, B, Z, J, W));
                            break;
                        case ct:
                            K.trigger("swipeRight", [j, H, B, Z, J, W]), g.swipeRight && (n = g.swipeRight.call(K, t, j, H, B, Z, J, W));
                            break;
                        case ht:
                            K.trigger("swipeUp", [j, H, B, Z, J, W]), g.swipeUp && (n = g.swipeUp.call(K, t, j, H, B, Z, J, W));
                            break;
                        case dt:
                            K.trigger("swipeDown", [j, H, B, Z, J, W]), g.swipeDown && (n = g.swipeDown.call(K, t, j, H, B, Z, J, W))
                    }
                }
            }
            if (i == vt) {
                if (K.trigger("pinchStatus", [e, X || null, Y || 0, B || 0, Z, U, J]), g.pinchStatus && !1 === (n = g.pinchStatus.call(K, t, e, X || null, Y || 0, B || 0, Z, U, J))) return !1;
                if (e == It && d()) switch (X) {
                    case ut:
                        K.trigger("pinchIn", [X || null, Y || 0, B || 0, Z, U, J]), g.pinchIn && (n = g.pinchIn.call(K, t, X || null, Y || 0, B || 0, Z, U, J));
                        break;
                    case ft:
                        K.trigger("pinchOut", [X || null, Y || 0, B || 0, Z, U, J]), g.pinchOut && (n = g.pinchOut.call(K, t, X || null, Y || 0, B || 0, Z, U, J))
                }
            }
            return i == bt ? e !== Et && e !== It || (clearTimeout(st), clearTimeout(rt), x() && !w() ? (ot = $(), st = setTimeout(at.proxy(function () {
                ot = null, K.trigger("tap", [t.target]), g.tap && (n = g.tap.call(K, t, t.target))
            }, this), g.doubleTapThreshold)) : (ot = null, K.trigger("tap", [t.target]), g.tap && (n = g.tap.call(K, t, t.target)))) : i == yt ? e !== Et && e !== It || (clearTimeout(st), clearTimeout(rt), ot = null, K.trigger("doubletap", [t.target]), g.doubleTap && (n = g.doubleTap.call(K, t, t.target))) : i == _t && (e !== Et && e !== It || (clearTimeout(st), ot = null, K.trigger("longtap", [t.target]), g.longTap && (n = g.longTap.call(K, t, t.target)))), n
        }
        ...
        function c() {
            var t = !1;
            return null !== g.cancelThreshold && null !== j && (t = E(j) - H >= g.cancelThreshold), t
        }
        ...
        function T(t) {
            K && (!0 === t ? (K.bind(F, i), K.bind(z, n), R && K.bind(R, s)) : (K.unbind(F, i, !1), K.unbind(z, n, !1), R && K.unbind(R, s, !1)), K.data(Dt + "_intouch", !0 === t))
        }
        ...
        function I(t) {
            var e = void 0 !== t.identifier ? t.identifier : 0,
                i = J[e] || null;
            return null === i && (i = C(e, t)), i.last.x = i.end.x, i.last.y = i.end.y, i.end.x = t.pageX || t.clientX, i.end.y = t.pageY || t.clientY, i
        }
        ...
        var O = Mt || Pt || !g.fallbackToMouseEvents,
            L = O ? Pt ? At ? "MSPointerDown" : "pointerdown" : "touchstart" : "mousedown",
            F = O ? Pt ? At ? "MSPointerMove" : "pointermove" : "touchmove" : "mousemove",
            z = O ? Pt ? At ? "MSPointerUp" : "pointerup" : "touchend" : "mouseup",
    ...
    var lt = "left",
        ...
        At = window.navigator.msPointerEnabled && !window.navigator.pointerEnabled && !Mt,
        Pt = (window.navigator.pointerEnabled || window.navigator.msPointerEnabled) && !Mt,
        Dt = "TouchSwipe";
    at.fn.swipe = function (t) {
        ...
        if (i && "string" == typeof t) {
            ...
            return !i || void 0 !== i.allowPageScroll || void 0 === i.swipe && void 0 === i.swipeStatus || (i.allowPageScroll = pt), void 0 !== i.click && void 0 === i.tap && (i.tap = i.click), i = i || {}, i = at.extend({}, at.fn.swipe.defaults, i), this.each(function () {
                var t = at(this),
                    e = t.data(Dt);
    ...
    e = this, i = function (l, s) {
        ...
        function t(t) {
            ...
            this.$element = t, this.element = t[0], this.didResize = !1, this.didScroll = !1, this.id = "context" + i++, this.oldScroll = {
                ...
                horizontal: {},
                vertical: {}
            }, t.data(h, this.id), d[this.id] = this, t.bind(p, function () {
                var t;
        ...
        return e = l(s), o = 0 <= _.call(s, "ontouchstart"), c = {
            horizontal: {},
            vertical: {}
        }, d = {}, h = "waypoints-context-id", f = "resize.waypoints", p = "scroll.waypoints", g = i = 1, m = "waypoints-waypoint-ids", v = "waypoint", b = "waypoints", t.prototype.doScroll = function () {
            var t, n = this;
            return t = {
                horizontal: {
            ...
            }, !o || t.vertical.oldScroll && t.vertical.newScroll || l[b]("refresh"), l.each(t, function (t, o) {
                var i, e, s;
            ...
            if (l.isEmptyObject(this.waypoints.horizontal) && l.isEmptyObject(this.waypoints.vertical)) return this.$element.unbind([f, p].join(" ")), delete d[this.id]
        }, r = t, y.prototype.trigger = function (t) {
            ...
            var t, e;
            return e = arguments[0], t = 2 <= arguments.length ? x.call(arguments, 1) : [], n[e] ? n[e].apply(this, t) : l.isFunction(e) ? n.init.apply(this, arguments) : l.isPlainObject(e) ? n.init.apply(this, [null, e]) : e ? l.error("The " + e + " method does not exist in jQuery Waypoints.") : l.error("jQuery Waypoints needs a callback function or handler option.")
        }, l.fn[v].defaults = {
            context: s,
            continuous: !0,
            enabled: !0,
            ...
            var t, e;
            return e = arguments[0], t = 2 <= arguments.length ? x.call(arguments, 1) : [], u[e] ? u[e].apply(null, t) : u.aggregate.call(null, e)
        }, l[b].settings = {
            resizeThrottle: 100,
            scrollThrottle: 30
        }, e.load(function () {
